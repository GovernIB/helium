...
//	@Value("${es.caib.helium.persistence.container-transactions-disabled:false}")
...
//	@Bean
//	@Primary
//	@ConditionalOnProperty(value = "es.caib.helium.persistence.transaction-manager.enabled", havingValue = "true", matchIfMissing = true)
