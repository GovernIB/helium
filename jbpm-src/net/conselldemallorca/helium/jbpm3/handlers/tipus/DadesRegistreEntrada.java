...
/**
 * Classe amb informació sobre un seient registral d'entrada.
 * 
 * @author Josep Gayà <josepg@limit.es>
 */
public class DadesRegistreEntrada {
	...
	private String anotacioUnitatAdministrativa;
	...
	public String getAnotacioUnitatAdministrativa() {
		return anotacioUnitatAdministrativa;
	}
	public void setAnotacioUnitatAdministrativa(String anotacioUnitatAdministrativa) {
		this.anotacioUnitatAdministrativa = anotacioUnitatAdministrativa;
	}
