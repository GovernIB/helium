...
//		}
	...
	public boolean isTascaValidada(WTaskInstance task) {
		Tasca tasca = findTascaByJbpmTask(task);
	...
	public boolean isDocumentsComplet(WTaskInstance task) {
		boolean ok = true;
		Tasca tasca = findTascaByJbpmTask(task);
	...
	public boolean isSignaturesComplet(WTaskInstance task) {
		boolean ok = true;
		Tasca tasca = findTascaByJbpmTask(task);
