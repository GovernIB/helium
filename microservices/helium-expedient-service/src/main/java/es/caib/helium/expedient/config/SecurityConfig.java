...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter { //extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/api/v1/expedients/**").hasAnyRole("HEL_USER", "HEL_ADMIN")
                .antMatchers("/api/v1/processos/**").hasAnyRole("HEL_USER", "HEL_ADMIN")
                .antMatchers("/api/v1/tasques/**").hasAnyRole("HEL_USER", "HEL_ADMIN")
                .anyRequest()
                .authenticated();
        http.csrf().disable();
    }
