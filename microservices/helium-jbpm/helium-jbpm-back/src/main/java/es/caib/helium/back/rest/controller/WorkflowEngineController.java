...
import es.caib.helium.back.rest.helper.VariableHelper;
import es.caib.helium.back.rest.model.ExpressionData;
import es.caib.helium.back.rest.model.InfoCacheData;
import es.caib.helium.back.rest.model.ProcessStartData;
import es.caib.helium.back.rest.model.ReassignTaskData;
import es.caib.helium.back.rest.model.RedirectTokenData;
import es.caib.helium.back.rest.model.ScriptData;
import es.caib.helium.back.rest.model.UpdateVariablesData;
import es.caib.helium.back.rest.model.VariableRest;
...
import static es.caib.helium.back.rest.helper.VariableHelper.objectMapToVariableRestConvert;
import static es.caib.helium.back.rest.helper.VariableHelper.objectToVariable;
import static es.caib.helium.back.rest.helper.VariableHelper.variableRestToObjectMapConvert;
