...
import es.caib.helium.api.dto.DocumentEnviamentEstatEnumDto;
import es.caib.helium.api.dto.DocumentNotificacioDto;
import es.caib.helium.api.dto.DocumentNotificacioTipusEnumDto;
import es.caib.helium.api.dto.ExpedientDto;
import es.caib.helium.api.dto.ExpedientTipusDto;
import es.caib.helium.api.dto.InteressatDocumentTipusEnumDto;
import es.caib.helium.api.dto.InteressatIdiomaEnumDto;
import es.caib.helium.api.dto.NotificacioDto;
