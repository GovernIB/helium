...
import es.caib.helium.api.dto.DadesEnviamentDto.EntregaPostalTipus;
import es.caib.helium.api.dto.ExpedientDto.IniciadorTipusDto;
import es.caib.helium.api.dto.RespostaNotificacio.NotificacioEstat;
import es.caib.helium.api.dto.TramitDocumentDto.TramitDocumentSignaturaDto;
import es.caib.helium.api.dto.TramitDto.TramitAutenticacioTipusDto;
import es.caib.helium.api.exception.ValidacioException;
