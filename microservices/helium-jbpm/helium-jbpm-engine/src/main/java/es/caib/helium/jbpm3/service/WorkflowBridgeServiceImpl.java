package es.caib.helium.jbpm3.service;
...
import es.caib.helium.api.service.WorkflowBridgeService;
import es.caib.helium.api.service.WorkflowEngineApi;
import es.caib.helium.jbpm3.command.AddToAutoSaveCommand;
import es.caib.helium.jbpm3.command.DeleteProcessInstanceLogsCommand;
import es.caib.helium.jbpm3.command.FindTaskInstanceIdForTokenIdCommand;
import es.caib.helium.jbpm3.command.GetProcessInstancesTreeCommand;
import es.caib.helium.jbpm3.command.TokenActivarCommand;
import es.caib.helium.jbpm3.command.TokenRedirectCommand;
...
import es.caib.helium.jbpm3.helper.DocumentsHelper.DocumentTasca;
import es.caib.helium.jbpm3.helper.EnumeracionsHelper.Enumeracio;
import es.caib.helium.jbpm3.helper.ExpedientsHelper.ExpedientError;
import es.caib.helium.jbpm3.helper.ExpedientsHelper.Georeferencia;
import es.caib.helium.jbpm3.helper.GenericsHelper.Email;
...
//        return documentsHelper.getCodiVariablePerDocumentCodi(documentCodi);
    ...
    public void documentExpedientEsborrar(
            ...
            String processInstanceId,
            String documentCodi) {
        DocumentTasca documentTasca = DocumentTasca.builder()
                .processInstanceId(processInstanceId)
                .taskInstanceId(taskInstanceId)
                .build();
        documentsHelper.documentExpedientEsborrar(documentCodi, documentTasca);
    }
