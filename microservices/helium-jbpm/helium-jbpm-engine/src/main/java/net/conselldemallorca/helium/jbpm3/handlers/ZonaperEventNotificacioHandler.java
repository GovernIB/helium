...
import net.conselldemallorca.helium.api.dto.DocumentEnviamentEstatEnumDto;
import net.conselldemallorca.helium.api.dto.DocumentNotificacioDto;
import net.conselldemallorca.helium.api.dto.DocumentNotificacioTipusEnumDto;
import net.conselldemallorca.helium.api.dto.ExpedientDto;
import net.conselldemallorca.helium.api.dto.ExpedientTipusDto;
import net.conselldemallorca.helium.api.dto.InteressatDocumentTipusEnumDto;
import net.conselldemallorca.helium.api.dto.InteressatIdiomaEnumDto;
import net.conselldemallorca.helium.api.dto.NotificacioDto;
