...
import net.conselldemallorca.helium.jbpm3.helper.*;
import net.conselldemallorca.helium.jbpm3.helper.AlertesHelper.Alerta;
import net.conselldemallorca.helium.jbpm3.helper.DocumentsHelper.DocumentAdjunt;
import net.conselldemallorca.helium.jbpm3.helper.DocumentsHelper.DocumentCrear;
import net.conselldemallorca.helium.jbpm3.helper.DocumentsHelper.DocumentGenerar;
import net.conselldemallorca.helium.jbpm3.helper.DocumentsHelper.DocumentGuardar;
import net.conselldemallorca.helium.jbpm3.helper.DocumentsHelper.DocumentRegistre;
import net.conselldemallorca.helium.jbpm3.helper.EnumeracionsHelper.Enumeracio;
import net.conselldemallorca.helium.jbpm3.helper.ExpedientsHelper.ExpedientError;
import net.conselldemallorca.helium.jbpm3.helper.ExpedientsHelper.Georeferencia;
import net.conselldemallorca.helium.jbpm3.helper.GenericsHelper.Email;
import net.conselldemallorca.helium.jbpm3.helper.TerminisHelper.TerminiCalcul;
import net.conselldemallorca.helium.jbpm3.helper.TerminisHelper.TerminiConfigurar;
import net.conselldemallorca.helium.jbpm3.helper.TerminisHelper.TerminiInici;
import net.conselldemallorca.helium.jbpm3.integracio.JbpmVars;
...
//    }
    ...
    public List<CampTascaDto> findCampsPerTaskInstance(
            ...
            String taskName) {
        return tasquesHelper.findCampsPerTaskInstance(
                processInstanceId,
                processDefinitionId,
                taskName);
    }
    ...
    public List<DocumentTascaDto> findDocumentsPerTaskInstance(
            ...
            String processDefinitionId,
            String taskName) {
        return tasquesHelper.findDocumentsPerTaskInstance(
                processInstanceId,
                processDefinitionId,
                taskName);
    }
...
//    }
//
//    class CookieFilter extends ClientFilter {
