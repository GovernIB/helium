...
import net.conselldemallorca.helium.api.dto.DadesEnviamentDto.EntregaPostalTipus;
import net.conselldemallorca.helium.api.dto.ExpedientDto.IniciadorTipusDto;
import net.conselldemallorca.helium.api.dto.RespostaNotificacio.NotificacioEstat;
import net.conselldemallorca.helium.api.dto.TramitDocumentDto.TramitDocumentSignaturaDto;
import net.conselldemallorca.helium.api.dto.TramitDto.TramitAutenticacioTipusDto;
import net.conselldemallorca.helium.api.exception.ValidacioException;
...
public class ConversioTipusHelper {
	...
	public static ExpedientInfo toExpedientInfo(ExpedientInfoDto expedient) {
		if (expedient == null)
			return null;
		...
		resposta.setComentariAnulat(expedient.getComentariAnulat());
		resposta.setInfoAturat(expedient.getInfoAturat());
		if (expedient.getIniciadorTipus() != null) {
			resposta.setIniciadorTipus(ExpedientInfo.IniciadorTipus.valueOf(expedient.getIniciadorTipus().name()));
		}
		resposta.setIniciadorCodi(expedient.getIniciadorCodi());
		resposta.setResponsableCodi(expedient.getResponsableCodi());
		resposta.setGeoPosX(expedient.getGeoPosX());
		...
		resposta.setTramitExpedientIdentificador(expedient.getTramitExpedientIdentificador());
		resposta.setTramitExpedientClau(expedient.getTramitExpedientClau());
		resposta.setExpedientTipusCodi(expedient.getExpedientTipusCodi());
		resposta.setExpedientTipusNom(expedient.getExpedientTipusNom());
		resposta.setEntornCodi(expedient.getEntornCodi());
		resposta.setEntornNom(expedient.getEntornNom());
		resposta.setEstatCodi(expedient.getEstatCodi());
		resposta.setEstatNom(expedient.getEstatNom());
		resposta.setProcessInstanceId(expedient.getProcessInstanceId());
		resposta.setAmbRetroaccio(expedient.isAmbRetroaccio());
		return resposta;
