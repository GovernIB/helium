...
public class NotificacioServiceNotibImpl implements NotificacioService {
	...
	public RespostaConsultaEstatNotificacio consultaNotificacio(String identificador) throws NotificacioPluginException {
		...
		try {
			es.caib.notib.ws.notificacio.RespostaConsultaEstatNotificacio respostaConsultaEstat = client.consultaEstatNotificacio(identificador);
	...
	public RespostaConsultaEstatEnviament consultaEnviament(String referencia) throws NotificacioPluginException {
		try {
			es.caib.notib.ws.notificacio.RespostaConsultaEstatEnviament respostaConsultaEstat = client.consultaEstatEnviament(referencia);
