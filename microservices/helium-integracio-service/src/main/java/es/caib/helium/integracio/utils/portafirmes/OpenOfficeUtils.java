package es.caib.helium.integracio.utils.portafirmes;
...
public class OpenOfficeUtils {
	...
	public OpenOfficeUtils(String host, Integer port, Integer timeout) {
		this.host = host;
		this.port = port;
	...
	private void convert(
		...
		try {
			...
			throw new PortaFirmesException("(Conversió OpenOffice)", e);
		} finally {
