...
public class ClienteCustodiaCaib {
	...
	public ClienteCustodiaCaib(String url, String usuario, String password, String baseUrl) {
		this.url = url;
...
//		init();
		var custodiaRequestBuilder = new CustodiaRequestBuilder(this.usuario, this.password);
		var xml = custodiaRequestBuilder.buildXML(documento, nombreDocumento, codigoExterno, codigoExternoTipoDocumento);
...
//		init();
	...
	public byte[] custodiarPDFFirmado(ByteArrayInputStream documento,
			String nombreDocumento,
			String codigoExterno,
			String codigoExternoTipoDocumento) throws RemoteException {
