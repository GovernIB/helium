...
ALTER TABLE HEL_USUARI_PREFS ADD  EMAIL_ALTERNATIU VARCHAR2(255);

ALTER TABLE HEL_EXPEDIENT_TIPUS ADD  ENVIAR_CORREU_ANOTACIONS NUMBER(1,0) BOOLEAN DEFAULT FALSE;
