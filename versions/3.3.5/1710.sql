...
ALTER TABLE HEL_INTERESSAT ADD REPRESENTAT_ID NUMBER(19);
ALTER TABLE HEL_INTERESSAT ADD REPRESENTANT_ID NUMBER(19);

ALTER TABLE HEL_INTERESSAT ADD CONSTRAINT HEL_INTERESSAT_REPRESENTAT_FK FOREIGN KEY (REPRESENTAT_ID) REFERENCES HEL_INTERESSAT(ID) ENABLE;
...
ALTER TABLE HEL_INTERESSAT ADD REPRESENTAT_ID BIGINT;
ALTER TABLE HEL_INTERESSAT ADD REPRESENTANT_ID BIGINT;

ALTER TABLE HEL_INTERESSAT ADD CONSTRAINT HEL_INTERESSAT_REPRESENTAT_FK FOREIGN KEY (REPRESENTAT_ID) REFERENCES HEL_INTERESSAT(ID);
