	...
	<body>		
		...
		<script>
			...
			function getConsultaInfo() {
				...
				$.ajax({
					type: 'GET',
					url: '<c:url value="/expedient/consulta/${consultaId}/informeAsync/info"/>',
					dataType: "json",
					traditional: true,
					async: false,
				  	data: {
			...
			function actualitzarInfoDescarrega(info) {
				if (info == null || info.estat == 'NO_TROBAT') {
					...
					case 'FINALITZAT':
						...
						window.location = '<c:url value="/expedient/consulta/${consultaId}/informeAsync/exportar"/>';
						informe = null;
						$('#informeDescarrega').css('visibility', 'hidden');
						break;
					case 'CANCELLAT':
			...
			function cancellarInforme() {
				...
				$.ajax({
					type: 'GET',
					url: '<c:url value="/expedient/consulta/${consultaId}/informeAsync/cancellar"/>',
					dataType: "json",
					traditional: true,
					async: false,
				  	data: {
