...
$(document).ready(function() {
    ...
    $('#documentId').on('change', function() {
        ...
        $.get('<c:url value="/expedient/${expedientDocumentPinbalDto.expedientId}/documentPinbal/' + varDocumentId + '/info"/>')
        .done(function(data) {
...
// 			botoConsultar.removeClass("disabled");
    ...
    $('#provinciaNaixament').on('change', function() {
        ...
        $(selectMuni).empty();
      	// Al canviar el tipus de document Pinbal, refrescar els titulars
        $.get('<c:url value="/expedient/getMunicipisPerProvincia/' + $(this).val() + '"/>')
        .done(function(data) {
            if (data) {
...
<body>
	<form:form cssClass="form-horizontal form-tasca" action="${formAction}" enctype="multipart/form-data" method="post" modelAttribute="expedientDocumentPinbalDto">
