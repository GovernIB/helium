...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#varCodi").on("change", function(e) {
			...
			if (e.val != "" && e.val != codi)
				window.location.replace('<c:url value="/modal/expedient/${expedientId}/proces/${procesId}/dada/"/>' + e.val + '/new');
			codi = e.val;
		});
		if (codi != "") {
			...
			if ($("#varCodi").val() == "__string") {
				...
				$("#nova").addClass("hide");
				if ($("#varCodi").val() != codi)
					$("#formulari").load('<c:url value="/modal/expedient/${expedientId}/proces/${procesId}/dada/"/>' + $("#varCodi").val() + '/update');
			}
		}
		</c:if>
