					...
					<c:if test="${potDissenyarDefinicioProcesAdmin}">
						<div id="versioAccions" class="dropdown" style="margin-right: -10px;">
							...
							<ul class="dropdown-menu">
								<li><a id="accioExportar" data-toggle="modal" data-modal-id="accioExportarDiv" href="/helium/definicioProces/${definicioProces.jbpmKey}/exportar?definicioProcesId=${definicioProces.id}"><span class="fa fa-sign-out"></span>&nbsp;<spring:message code="comu.filtre.exportar"/></a></li>
								<li><a id="accioImportar" data-toggle="modal" data-modal-id="accioImportarDiv" href="/helium/definicioProces/importar?definicioProcesId=${definicioProces.id}"><span class="fa fa-sign-in"></span>&nbsp;<spring:message code="comu.importar"/></a></li>
								<li><a id="accioEsborrar" href="/helium/definicioProces/${definicioProces.jbpmKey}/${definicioProces.id}/delete" data-rdt-link-ajax="true" data-confirm="<spring:message code="definicio.proces.pipelles.confirmacio.esborrar"/>"><span class="fa fa-trash-o"></span>&nbsp;<spring:message code="comu.boto.esborrar"/></a></li>
							</ul>
						</div>
					</c:if>
				</div>
	...
	<div class="row">
		<div id="definicioProces-pipelles" class="col-md-12">
			...
			<div class="tab-content">
				<div id="contingut-detall" class="tab-pane" data-href="<c:url value="/nodeco/definicioProces/${definicioProces.jbpmKey}/${definicioProces.id}/detall"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-tasques" class="tab-pane" data-href="<c:url value="/nodeco/definicioProces/${definicioProces.jbpmKey}/${definicioProces.id}/tasca"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-variables" class="tab-pane" data-href="<c:url value="/nodeco/definicioProces/${definicioProces.jbpmKey}/${definicioProces.id}/variable"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-documents" class="tab-pane" data-href="<c:url value="/nodeco/definicioProces/${definicioProces.jbpmKey}/${definicioProces.id}/documents"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-terminis" class="tab-pane" data-href="<c:url value="/nodeco/definicioProces/${definicioProces.jbpmKey}/${definicioProces.id}/terminis"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
