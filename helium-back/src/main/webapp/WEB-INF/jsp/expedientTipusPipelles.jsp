	...
	<div class="row">
		<div id="expedientTipus-pipelles" class="col-md-12">
			...
			<div class="tab-content">
				<div id="contingut-informacio" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/informacio"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<c:if test="${expedientTipus.tipus == 'FLOW'}">
					<div id="contingut-definicions-proces" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/definicionsProces"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<div id="contingut-variables" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/variables"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-documents" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/documents"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-tasques" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/tasques"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-terminis" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/terminis"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-accions" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/accions"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-estats" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/estats"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-enumeracions" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/enumeracions"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-dominis" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/dominis"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-consultes" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/consultes"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-metadadesnti" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/metadadesNti"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-integracio-tramits" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/integracioTramits"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-integracio-distribucio" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/integracioDistribucio"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-integracio-forms" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/integracioForms"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-integracio-notib" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/integracioNotib"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-integracio-pinbal" class="tab-pane" data-href="<c:url value="/nodeco/expedientTipus/${expedientTipus.id}/integracioPinbal"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
