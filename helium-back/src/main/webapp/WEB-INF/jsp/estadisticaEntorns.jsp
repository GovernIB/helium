...
$(document).ready(function() {
		...
		$('#expedientTipusId').on('change', function() {
			...
			$.get('<c:url value="/estadistica/estatsPerTipus/"/>' + tipus)
			.done(function(data) {
		...
		$('#entornId').on('change', function() {
			...
			$.get('<c:url value="/estadistica/expedientTipusPerEntorn/"/>' + entorn)
			.done(function(data) {
...
<form:form id="excel" action="/helium/estadistica/excel" method="post" modelAttribute="expedientTipusEstadisticaCommand">
