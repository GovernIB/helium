...
<link
	...
	rel="stylesheet" />
<link
	href="<c:url value="/css/select2-bootstrap.css"/>"
	rel="stylesheet" />
<script
	src="<c:url value="/webjars/select2/3.4.8/select2.min.js"/>"></script>
<script
	src="<c:url value="/webjars/select2/3.4.8/dist/js/i18n/${idioma}.js"/>"></script>
...
<script type="application/javascript">
		...
		function executeCanviCodi(lineRow, codiAntic, codiNou, callback) {
			$.post('<c:url value="/usernames/"/>' + codiAntic + '/changeTo/' + codiNou)
