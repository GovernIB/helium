	...
	<div class="row">
		<div id="area-pipelles" class="col-md-12">
			...
			<div class="tab-content">
				<div id="contingut-configurades" class="tab-pane" data-href="<c:url value="/nodeco/area/configurades"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-no-configurades" class="tab-pane" data-href="<c:url value="/nodeco/area/sense/configurar"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
			</div>
		</div>
