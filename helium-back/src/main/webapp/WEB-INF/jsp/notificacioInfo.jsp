								...
								<thead>
									<tr>
										<td class="left" style="max-width: 60px;">
											<a href="<c:url value="/expedient/${expedientId}/notificacio/${notificacio.id}/proces/${notificacio.expedient.processInstanceId}/document/${notificacio.document.id}/descarregar"/>">
						...
						<c:forEach var="annex" items="${notificacio.annexos}">
							...
							<table id="document_${annex.id}" class="table-condensed marTop6 tableDocuments">
								<thead>
									<tr>
										<td class="left" style="max-width: 60px;">
											<a href="<c:url value="/expedient/${expedientId}/notificacio/${notificacio.id}/proces/${notificacio.expedient.processInstanceId}/document/${annex.id}/descarregar"/>">
												<span class="fa fa-file fa-4x" title="Descarregar document"></span>
												<span class="extensionIcon">
