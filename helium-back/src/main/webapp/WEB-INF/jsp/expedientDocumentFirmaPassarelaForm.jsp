...
<body>
	<c:if test="${potFirmar}">
		<c:set var="formAction">
			<c:url value="/expedient/${expedientId}/proces/${document.processInstanceId}/document/${document.id}/firmaPassarela"/>
		</c:set>
		<form:form 	cssClass="form-horizontal" action="${formAction}" enctype="multipart/form-data" method="post" modelAttribute="documentExpedientFirmaPassarelaCommand">
			<div>
