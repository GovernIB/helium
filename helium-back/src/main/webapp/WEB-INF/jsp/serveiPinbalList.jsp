					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown navbar-right">
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/serveisPinbal/{{:id}}"/>" data-toggle="modal" class="consultar-expedient"><span class="fa fa-pencil"></span>&nbsp;<spring:message code="serveisPinbal.boto.modificar"/></a></li>
							</ul>
						</div>
					</script>
				</th>
