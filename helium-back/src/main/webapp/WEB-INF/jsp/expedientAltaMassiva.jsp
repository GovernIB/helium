		...
		<div class="row">
			<div class="form-group">
				...
				<p class="comment col-xs-9 col-xs-offset-3">
					...
					<a id="arxiuCsvExemple" href="<c:url value="/expedient/altaMassiva/exempleCsv"/>" class="text text-success" title="<spring:message code="expedient.alta.massiva.form.file.exemple"></spring:message>"><span class="fa fa-download"></span></a>
				</p>
			</div>
	...
	<script type="text/javascript">
		...
		$(document).ready( function() {
			...
			$("button[name=resultats]").click(function(e) {
				if (darreraExecucioMassiva) {
					...
					var resultatsUrl = '<c:url value="/expedient/altaMassiva"/>/' + darreraExecucioMassiva.id + '/resultat';
		...
		function carregaDades() {
			...
			if (expedientTipusId) {
				...
				var url = '<c:url value="/expedient/altaMassiva/dades"/>/' + expedientTipusId;
				$.ajax({
		            url : url,
		            type : 'GET',
		            dataType : 'json',
