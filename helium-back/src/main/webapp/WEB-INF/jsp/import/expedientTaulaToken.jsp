					...
					<c:choose>
						<c:when test="${empty token.end}">
							<a  class="icon retroces" 
								...
								href='<c:url value="../../expedient/${expedientId}/proces/${procesId}/token/${token.id}/retrocedir"/>' 
							...
							<a  class="icon" 
								...
								href='<c:url value="../../expedient/${expedientId}/proces/${procesId}/token/${token.id}/activar"/>' 
								data-rdt-link-callback="recargarPanelToken(${procesId});">
