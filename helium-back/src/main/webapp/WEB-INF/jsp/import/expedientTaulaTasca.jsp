	...
	<tr id="table-tasca-${tasca.id}">
		<td>
			...
			<c:if test="${not empty tasca.errorFinalitzacio or not empty tasca.marcadaFinalitzar or not empty tasca.iniciFinalitzacio}">
				<a class="icon" data-rdt-link-modal="true" href="<c:url value="/modal/expedient/${expedient.id}/execucioInfo/${tasca.id}"/>">
			...
			<div class="btn-group">
				...
				<ul id="dropdown-menu-${tasca.id}" class="dropdown-menu">
					...
					<c:if test="${tasca.open and not tasca.suspended and not tasca.agafada and not empty tasca.responsables and tasca.assignadaUsuariActual}">
						<li><a data-rdt-link-callback="agafar(${procesId},${tasca.id});" data-rdt-link-ajax=true class="icon" href="<c:url value="/expedient/${expedient.id}/tasca/${tasca.id}/agafar"/>"><span class="fa fa-chain"></span>&nbsp;<spring:message code="tasca.llistat.accio.agafar"/></a></li>
					</c:if>
					...
					<c:if test="${expedient.permisTaskManagement and tasca.suspended}">
						<li><a href="<c:url value="/expedient/${expedient.id}/tasca/${tasca.id}/reprendre"/>" data-rdt-link-callback="recarregarLlistatTasques(${procesId},${tasca.id});" data-rdt-link-confirm="<spring:message code="expedient.tasca.confirmacio.reprendre"/>"><span class="fa fa-play"></span> <spring:message code="tasca.llistat.accio.reprendre"/></a></li>
					</c:if>
					<c:if test="${expedient.permisTaskManagement and not tasca.completed and not tasca.cancelled}">
						<li><a href="<c:url value="/expedient/${expedient.id}/tasca/${tasca.id}/cancelar"/>" data-rdt-link-callback="recarregarLlistatTasques(${procesId},${tasca.id});" data-rdt-link-confirm="<spring:message code="expedient.tasca.confirmacio.cancelar"/>"><span class="fa fa-times"></span> <spring:message code="tasca.llistat.accio.cancelar"/></a></li>
					</c:if>
				</ul>
