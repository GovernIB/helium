...
function agafar(procesId, tascaId, correcte) {
	if (correcte) {		
		var url = '<c:url value="/nodeco/expedient/${expedientId}/tasca/'+tascaId+'/refrescarPanel/"/>' + procesId;
...
function recarregarLlistatTasques(procesId, tascaId, correcte) {
	if (correcte) {
		var url = '<c:url value="/nodeco/expedient/${expedientId}/refrescarLlistat"/>';
