...
<%@ taglib tagdir="/WEB-INF/tags/helium" prefix="hel"%>
 				...
 				<th data-col-name="id" data-template="#cellAnotacioAccionsTemplate" data-orderable="false" width="10%"> 
					...
					<div class="dropdown">
							...
							<ul class="dropdown-menu pull-right">
								<li>							
									<a href="<c:url value="/anotacio/{{:id}}"/>" data-toggle="modal" data-maximized="true"><span class="fa fa-info-circle"></span>&nbsp;<spring:message code="comu.boto.detalls"/></a>
								</li>
								<li>
								<c:if test="${expedient.tipus.distribucioSistra == true}">
									<c:choose>
										<c:when test="${dadesPersona.admin || potProcessarAnotacions}">
											<li>
												<a id="selection" href="<c:url value="/expedient/{{:expedient.id}}/anotacio/{{:id}}/{{:false}}/reprocessarMapeig"/>" data-toggle="modal" data-datatable-id="" title="<spring:message code="expedient.anotacio.llistat.reprocessar.mapeig.title"/>">
													<span class="fa fa-cog"></span>&nbsp;<spring:message code="expedient.anotacio.llistat.reprocessar.mapeig"/>
												</a>
											</li>
											<li>
												<a href="<c:url value="/expedient/{{:expedient.id}}/anotacio/{{:id}}/{{:true}}"/>" title="<spring:message code="expedient.anotacio.llistat.processar.traspas.title"/>">
	...
	<script id="rowhrefTemplateAnotacions" type="text/x-jsrender"><c:url value="/anotacio/{{:id}}"/></script>
