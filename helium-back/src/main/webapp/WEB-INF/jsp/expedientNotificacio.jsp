						...
						<td style="width:120px">
							<div id="dropdown-menu-accions" class="dropdown pull-right">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a id="notificacioInfo" data-rdt-link-modal="true" data-rdt-link-modal-maximize="true" href="<c:url value="../../expedient/${expedient.id}/notificacio/${notificacio.id}/info"/>"><span class="fa fa-file"></span> <spring:message code="expedient.notificacio.info"/></a></li>
									<c:if test="${not empty notificacio.error && (notificacio.estat == 'PROCESSAT_REBUTJAT' || notificacio.estat == 'PROCESSAT_ERROR')}">
										<li><a href="<c:url value="/expedient/${expedient.id}/notificacio/${notificacio.id}/processar"/>"><span class="fa fa-refresh"></span> <spring:message code="expedient.notificacio.tornar_processar"/></a></li>
									</c:if>
	 							</ul>
 							</div>
						</td>
