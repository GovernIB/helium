...
<body>			
	...
	<div class="row">
		<div class="col-sm-12">
			<a class="btn btn-primary right" style="float: right;" title="<spring:message code='consulta.camps.mostrarxml' />" alt="<spring:message code='consulta.camps.mostrarxml' />" href="<c:url value="/expedientTipus/${expedientTipusId}/consulta/reportDownload"><c:param name="consultaId" value="${consulta.id}"/></c:url>"><img src="<c:url value="/img/page_white_code.png"/>" border="0"/></a>
		</div>
	</div>
	...
	function updateNumeric(input) {
		...
		var getUrl = '<c:url value="/expedientTipus/${expedientTipusId}/consulta/${consulta.id}/var/"/>'+variableId+'/'+propietat;
	...
	function canviarPosicioConsultaVar( id, pos) {
		...
		var getUrl = '<c:url value="/expedientTipus/${expedientTipusId}/consulta/${consulta.id}/var/"/>'+id+'/moure/'+pos;
		$.ajax({
			type: 'GET',
			url: getUrl,
			async: true,
	...
	function refrescaVariables() {
		var getUrl = '<c:url value="/expedientTipus/${expedientTipusId}/consulta/${consulta.id}/var/select"/>';
		$.ajax({
			type: 'GET',
			url: getUrl,
			dataType: "json",
