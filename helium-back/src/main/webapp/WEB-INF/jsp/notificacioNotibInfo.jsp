...
<body>
	<c:if test="${not empty dto}">
		<dl class="dl-horizontal">
			...
			<dd>
				<a href="<c:url value="/expedient/${dto.expedient.id}"/>" 
			...
			<dd>
				<a href="<c:url value="/expedient/${dto.expedient.id}/proces/${dto.expedient.processInstanceId}/document/${dto.documentStoreId}/descarregar"/>"
			...
			<dd>
				<c:if test="${not empty dto.justificantId}">
					<a href="<c:url value="/expedient/${dto.expedient.id}/proces/${dto.expedient.processInstanceId}/document/${dto.justificantId}/descarregar"/>"
