...
<body>
	...
	<a href="<c:url value="/expedientTipus/${expedientTipus.id}/netejarDp"/>" class="btn btn-default pull-right"><span class="fa fa-arrow-left"></span> <spring:message code="comu.boto.tornar"/></a>
</body>
</html>