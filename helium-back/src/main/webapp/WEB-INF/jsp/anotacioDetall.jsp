 							...
 							<div id="collapse-annex-${status.index}" class="panel-collapse collapse collapse-annex" role="tabpanel" aria-labelledby="dadesAnnex${status.index}" data-registre-id="${anotacio.id}"  data-fitxer-arxiu-uuid="${annex.uuid}">
								...
								<tbody>														
									...
									<tr>
										...
										<td>
											${annex.nom}
											<a href='<c:url value="/anotacio/${anotacio.id}/annex/${annex.id}/descarregar/imprimible"></c:url>' 
											...
											<a href='<c:url value="/anotacio/${anotacio.id}/annex/${annex.id}/descarregar/original"></c:url>' 
												class="btn btn-default btn-sm pull-right arxiu-download">
											...
											<%-- <a
	 											href="../../expedient/${anotacio.id}/proces/${document.processinstanceid}/document/${annex.id}/preview"
												href="../../expedient/191552/proces/13372599/document/166854/preview"
