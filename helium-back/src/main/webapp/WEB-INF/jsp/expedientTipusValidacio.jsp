...
<body>			
	...
	<form:form id="validacio-form" cssClass="form-horizontal" action="#" enctype="multipart/form-data" method="post" modelAttribute="validacioCommand" 
	...
	function canviarPosicioValidacio( id, pos) {
		...
		var getUrl = '<c:url value="/${basicUrl}/variable/${camp.id}/validacio/"/>'+id+'/moure/'+pos;
		$.ajax({
			type: 'GET',
			url: getUrl,
			async: true,
