					...
					<script id="cellAnotacioAccioTemplate" type="text/x-jsrender">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/anotacio/{{:id}}"/>" data-toggle="modal" data-maximized="true"><span class="fa fa-info-circle"></span>&nbsp;<spring:message code="comu.boto.detalls"/></a></li>
								{{if expedient != null }}
									<li><a href="<c:url value="/expedient/{{:expedient.id}}"/>"><span class="fa fa-folder-open"></span>&nbsp;<spring:message code="anotacio.llistat.accio.expedient"/></a></li>
								{{/if}}
								{{if estat == 'PENDENT'}}
									<li><a href="<c:url value="/anotacio/{{:id}}/acceptar"/>" data-maximized="true" data-toggle="modal"><span class="fa fa-check"></span>&nbsp;<spring:message code="comu.boto.acceptar"/></a></li>
									<li><a href="<c:url value="/anotacio/{{:id}}/rebutjar"/>" data-toggle="modal" data-min-height="1200"><span class="fa fa-times"></span>&nbsp;<spring:message code="comu.boto.rebutjar"/></a></li>
								{{/if}}
								{{if estat == 'PENDENT' || estat == 'COMUNICADA' || estat == 'ERROR_PROCESSANT'}}
									<li><a href="<c:url value="/anotacio/{{:id}}/delete"/>" data-rdt-link-ajax="true" data-confirm="<spring:message code="anotacio.llistat.confirmacio.esborrar"/>"><span class="fa fa-trash-o"></span>&nbsp;<spring:message code="comu.boto.esborrar"/></a></li>
								{{/if}}
								{{if estat == 'ERROR_PROCESSANT'}}
									<li><a href="<c:url value="/anotacio/{{:id}}/reprocessar"/>" data-rdt-link-ajax="true"><span class="fa fa-cog"></span>&nbsp;<spring:message code="anotacio.llistat.accio.reprocessar"/></a></li>
									<li><a href="<c:url value="/anotacio/{{:id}}/marcarPendent"/>" data-rdt-link-ajax="true"><span class="fa fa-check"></span>&nbsp;<spring:message code="anotacio.llistat.accio.marcarPendent"/></a></li>
								{{/if}}
								{{if estat == 'COMUNICADA' && consultaIntents >= ${maxConsultaIntents}}}
 									<li><a href="<c:url value="/anotacio/{{:id}}/reintentarConsulta"/>" data-rdt-link-ajax="true"><span class="fa fa-eraser"></span>&nbsp;<spring:message code="anotacio.llistat.accio.reintentarConsulta"/></a></li>
								{{/if}}
								{{if estat == 'REBUTJADA'}}
									<li><a href="<c:url value="/anotacio/{{:id}}/reprocessar"/>" data-rdt-link-ajax="true"><span class="fa fa-cog"></span>&nbsp;<spring:message code="anotacio.llistat.accio.reprocessar"/></a></li>
									<li><a href="<c:url value="/anotacio/{{:id}}/marcarPendent"/>" data-rdt-link-ajax="true"><span class="fa fa-check"></span>&nbsp;<spring:message code="anotacio.llistat.accio.marcarPendent"/></a></li>
		...
		<div class="botons-titol text-right">
			...
			<div id="btnTramitacio" class="btn-group">
				...
				<button class="btn btn-default" data-toggle="dropdown"><span class="fa fa-cog"></span>&nbsp;<spring:message code="comu.boto.accions"/>&nbsp;<span id="tramitacioMassivaCount" class="badge">&nbsp;&nbsp;</span>&nbsp;<span class="caret"></span></button>
 					<ul class="dropdown-menu">
						<li><a id="selection" href="<c:url value="/anotacio/reintentarConsulta"/>" data-maximized="true" data-rdt-link-ajax="true" title="<spring:message code="anotacio.llistat.reintentar.consulta.title"/>"><spring:message code="anotacio.llistat.reintentar.consulta"/></a></li>
 						<li><a id="selection" href="<c:url value="/anotacio/reintentarProcessament"/>" data-rdt-link-ajax="true" title="<spring:message code="anotacio.llistat.reintentar.processament.title"/>"><spring:message code="anotacio.llistat.reintentar.processament"/></a></li>
						<li><a id="selection" href="<c:url value="/anotacio/reprocessarMapeig"/>" data-toggle="modal" data-datatable-id="" title="<spring:message code="anotacio.llistat.reintentar.mapeig.title"/>"><spring:message code="anotacio.llistat.reintentar.mapeig"/></a></li>
						<li><a id="selection" href="<c:url value="/anotacio/reintentarProcessamentNomesAnnexos"/>" data-rdt-link-ajax="true" title="<spring:message code="anotacio.llistat.reintentar.processament.nomes.annexos.title"/>"><spring:message code="anotacio.llistat.reintentar.processament.nomes.annexos"/></a></li>
						<li><a id="selection" href="<c:url value="/anotacio/esborrarAnotacions"/>" data-rdt-link-ajax="true" title="<spring:message code="anotacio.llistat.esborrar.anotacions.title"/>"><spring:message code="anotacio.llistat.esborrar.anotacions"/></a></li>
 					</ul>
			</div>
		</div>
	</script>
