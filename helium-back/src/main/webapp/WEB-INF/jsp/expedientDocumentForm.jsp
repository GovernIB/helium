...
$(document).ready( function() {
	...
	<c:when test="${ambDocument}">
		...
		if (generarPlantilla) {
			...
			var href = '<c:url value="/modal/expedient/${expedientId}/proces/${document != null? document.processInstanceId : processInstanceId}/document/${documentExpedientCommand.codi}/generar"/>';
			console.log(href);
		...
		$('#documentCodi')
			...
			.change(function() {
				...
				if (dadesNti[documentCodi].plantilla && !dadesNti[documentCodi].generarNomesTasca) {
						// Per documents tipus plantlilla mostra un enllaç a la generació de documents
						var href = '<c:url value="/modal/expedient/${expedientId}/proces/${document != null? document.processInstanceId : processInstanceId}/document/{documentCodi}/generar"/>';
...
<body>
	<c:url value="/expedient/${expedientId}/proces/${document.processInstanceId}/document/${document.id}/descarregar" var="downloadUrl"/>
					...
					<c:if test="${empty document || document.plantilla}">
						...
						<div style="display: none;">
							<a 	id="generarPlantillaBtn"
								...
								href="<c:url value="/modal/expedient/${expedientId}/proces/${document.processInstanceId}/document/${document.documentCodi}/generar"/>">
