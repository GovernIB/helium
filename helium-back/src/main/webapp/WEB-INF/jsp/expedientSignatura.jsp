...
<%@ taglib tagdir="/WEB-INF/tags/helium" prefix="hel"%>
			...
			<tr>
				...
				<th data-col-name="documentNom" data-template="#cellDocTemplate" width="15%" data-orderable="false"><spring:message code="consultes.potafib.camp.nomDoc"/>
					<script id="cellDocTemplate" type="text/x-jsrender">
						<a href="<c:url value="/expedient/{{:expedientId}}/document/{{:documentStoreId}}/descarregar"/>" target="_blank">{{:documentNom}}</a>
					</script>
				</th>					
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown navbar-right">
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/enviamentsPortafib/{{:id}}/info"/>" data-toggle="modal" class="consultar-expedient"><span class="fa fa-info-circle"></span>&nbsp;<spring:message code="consultes.pinbal.boto.info"/></a></li>
							</ul>
						</div>
					</script>
				</th>
	...
	<script id="rowhrefTemplateSignatures" type="text/x-jsrender"><c:url value="/enviamentsPortafib/{{:id}}/info"/></script>
