...
<c:choose>
    <c:when test="${not empty processInstanceId}">
        <c:url var="downloadUrl" value="/expedient/${expedientId}/proces/${processInstanceId}/document/${documentStoreId}/descarregar" />
    </c:when>
    <c:otherwise>
        <c:url var="downloadUrl" value="/expedient/${expedientId}/document/${documentStoreId}/descarregar" />
    </c:otherwise>
</c:choose>
