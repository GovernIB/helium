...
<script type="application/javascript">
	...
	$(document).ready(() => {
		...
		$("#expedientDades").on('click', (event) => {
			...
			if (editable) {
				...
				$.get("<c:url value="/nodeco/expedient/${expedient.id}/dada/"/>" + dadaCodi + "/edit", function(data) {
					dadaEdit.html(data);
	...
	const submitEditForm = (fomulari) => {
		...
		$.ajax({
			type: 'POST',
			url: "<c:url value="/nodeco/expedient/${expedient.id}/proces/${expedient.processInstanceId}/dada/"/>" + dadaCodi + "/edit",
...
<c:url var="urlDatatable" value="/expedient/${expedient.id}/dada/datatable"/>
...
<script id="tableButtonsDadesTemplate" type="text/x-jsrender">
	<div class="botons-titol text-right">
		...
		<a id="descarregarDades" href="<c:url value="/expedient/${expedient.id}/dades/descarregar"/>" class="btn btn-default" title="<spring:message code="expedient.dada.descarregar"/>">
