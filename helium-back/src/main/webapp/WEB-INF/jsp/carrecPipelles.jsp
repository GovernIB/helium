	...
	<div class="row">
		<div id="carrec-pipelles" class="col-md-12">
			...
			<div class="tab-content">
				<div id="contingut-configurats" class="tab-pane" data-href="<c:url value="/nodeco/carrec/configurats"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<div id="contingut-no-configurats" class="tab-pane" data-href="<c:url value="/nodeco/carrec/sense/configurar"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
			</div>
		</div>
