						...
						<div id="expedientTipus-info-accio" class="dropdown">
							...
							<ul class="dropdown-menu">
								<c:if test="${ potDissenyarExpedientTipusAdmin }">
									<li><a data-toggle="modal" href="<c:url value="/expedientTipus/${expedientTipus.id}/update"/>"><span class="fa fa-pencil"></span>&nbsp;<spring:message code="expedient.tipus.info.accio.modificar"/></a></li>
									<li><a data-toggle="modal" href="<c:url value="/expedientTipus/${expedientTipus.id}/exportar"/>"><span class="fa fa-sign-out"></span>&nbsp;<spring:message code="comu.filtre.exportar"/></a></li>
									<li><a data-toggle="modal" href="<c:url value="/expedientTipus/importar?expedientTipusId=${expedientTipus.id}"/>"><span class="fa fa-sign-in"></span>&nbsp;<spring:message code="comu.importar"/></a></li>
								</c:if>
								<c:if test="${expedientTipus.tipus eq 'FLOW'}">
									<c:if test="${ potDissenyarExpedientTipusDelegat}">
										<li><a href="<c:url value="/expedientTipus/${expedientTipus.id}/propagarPlantilles"/>" title="<spring:message code="exptipus.info.propagar.plantilles.info"/>" ><span class="fa fa-cog"></span>&nbsp;<spring:message code="exptipus.info.propagar.plantilles"/></a></li>
										<li><a href="<c:url value="/expedientTipus/${expedientTipus.id}/propagarConsultes"/>" title="<spring:message code="exptipus.info.propagar.consultes.info"/>" ><span class="fa fa-cog"></span>&nbsp;<spring:message code="exptipus.info.propagar.consultes"/></a></li>
									</c:if>
									<c:if test="${ potDissenyarExpedientTipusAdmin }">
										<li><a data-toggle="modal" href="<c:url value="/expedientTipus/${expedientTipus.id}/propagarHandlers"/>" title="<spring:message code="expedient.info.propagar.handlers.info"/>" ><span class="fa fa-cog"></span>&nbsp;<spring:message code="expedient.info.propagar.handlers"/> ...</a></li>
									</c:if>
								</c:if>
								<c:if test="${potDissenyarEntorn or potAdministrarEntorn}">
									<li class="divider"></li>
									<li><a href="<c:url value="/expedientTipus/${expedientTipus.id}/delete"/>" data-confirm="<spring:message code="expedient.tipus.llistat.confirmacio.esborrar"/>"><span class="fa fa-trash-o"></span>&nbsp;<spring:message code="expedient.llistat.accio.esborrar"/></a></li>
								</c:if>
							</ul>
						</div>
					</c:if>
