...
<body>		
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								{{if !aturat && permisWrite}}<li><a href="<c:url value="../expedient/{{:id}}/suspend"/>" data-rdt-link-modal="true"><span class="fa fa-stop"></span>&nbsp;<spring:message code='comuns.aturar'/></a></li>{{/if}}
								{{if !anulat && permisWrite}}<li><a href="<c:url value="../expedient/{{:id}}/cancel"/>" data-rdt-link-modal="true"><span class="fa fa-times"></span>&nbsp;<spring:message code='comuns.anular'/></a></li>{{/if}}
								{{if anulat && permisWrite}}<li><a href="<c:url value="../expedient/{{:id}}/reprendre"/>" data-rdt-link-callback="recarregarTaula(taulaDades);" data-rdt-link-ajax="true" data-rdt-link-confirm="<spring:message code="expedient.consulta.confirm.desanular"/>">&nbsp;<span class="fa fa-reply"></span>&nbsp;<spring:message code="expedient.tasca.accio.reprendre"/></a></li>{{/if}}
	...
	<script id="tableButtonsTemplate" type="text/x-jsrender">
		<div class="btn-group pull-right">
			<a class="btn btn-default" href="<c:url value="../informe/${consulta.id}/seleccioTots"/>" data-rdt-link-ajax="true" title="<spring:message code="expedient.llistat.accio.seleccio.tots"/>"><span class="fa fa-check-square-o"></span></a>
			<a class="btn btn-default" href="<c:url value="../informe/${consulta.id}/seleccioNetejar"/>" data-rdt-link-ajax="true" title="<spring:message code="expedient.llistat.accio.seleccio.netejar"/>"><span class="fa fa-square-o"></span></a>
		...
		<div id="btn_exportar" class="btn-toolbar pull-right btn_under_taulaDades">
			<c:if test="${consulta.exportarActiu}">
				<a id="exportar_excel" href="<c:url value="../informe/${consulta.id}/exportar_excel"/>" class="btn btn-default">
			...
			<c:if test="${not empty consulta.informeNom and not empty campsInformeParams}">
				<a data-rdt-link-modal="true" id="mostrar_informe" href="<c:url value="../informe/${consulta.id}/mostrar_informe_params"/>" class="btn btn-default">
			...
			<c:if test="${not empty consulta.informeNom and empty campsInformeParams}">
				<a id="mostrar_informe" href="<c:url value="../informe/${consulta.id}/mostrar_informe"/>" class="btn btn-default">
					<span class="fa fa-file-text-o"></span>&nbsp;<spring:message code="expedient.consulta.informe"/>
				</a>
			</c:if>
		</div>			
