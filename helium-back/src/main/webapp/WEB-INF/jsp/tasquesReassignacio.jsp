...
<html>
	...
	<body>		
		<form:form id="reassignacioTasques" name="reassignacioTasques" action="" method="post" modelAttribute="reassignacioTasquesCommand" onsubmit="return confirmarReassignar(event)">
			...
			<div class="ctrlHolder">
				<div id="duser">
					<hel:inputSuggest required="true" name="usuari" urlConsultaInicial="/helium/expedient/persona/suggestInici" urlConsultaLlistat="/helium/expedient/persona/suggest" textKey="expedient.editar.responsable" placeholderKey="expedient.editar.responsable"/>
				</div>
				<div id="dgrup">
