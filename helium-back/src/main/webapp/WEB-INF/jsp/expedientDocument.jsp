...
<div class="${potAfegir ? 'pull-left' : '' }" style="padding: 5px; height: 50px;">
	<div class="pull-left">
		<a id="descarregarZip"
			href="<c:url value="/expedient/${expedient.id}/document/descarregarZip"/>" class="btn btn-default" title="<spring:message code="expedient.document.descarregar.zip"/>">
...
function recargarPanel (processInstanceId, correcte) {
	if (correcte) {
		...
		var url = '<c:url value="/nodeco/expedient/${expedientId}/proces/"/>' + processInstanceId + '/document?sort=' + sort;
