...
<%--						<span class="fa fa-cog"></span> --%>
	...
	<a href="<c:url value="/expedientTipus/${expedientTipus.id}?pipellaActiva=estats"/>" class="btn btn-default pull-right"><span class="fa fa-arrow-left"></span> <spring:message code="comu.boto.tornar"/></a>
	<script>
		var filaMovem;
		...
		function canviarPosicioRegla(id, pos) {
			...
			var getUrl = '<c:url value="/expedientTipus/${expedientTipus.id}/estat/${estat.id}/regla/"/>' + id + '/moure/' + posicioRelativa;
