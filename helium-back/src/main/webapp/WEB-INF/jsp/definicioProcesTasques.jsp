...
<c:choose>
	<c:when test="${not empty definicioProcesId}">		
		<table	id="definicioProcesTasques"
				...
				data-url="<c:url value='/definicioProces/${jbpmKey}/${definicioProcesId}/tasca/datatable'/>"
				...
				<tr>
					...
					<th data-col-name="campsCount" data-template="#cellFirmesTemplate" data-orderable="false" width="13%">
						<script id="cellFirmesTemplate" type="text/x-jsrender">
							<a href="<c:url value='/definicioProces'/>/${jbpmKey}/${definicioProcesId}/tasca/{{:id}}/variable" data-maximized="true" data-toggle="modal" data-callback="callbackModalTasques()" class="btn btn-default"><spring:message code="definicio.proces.tasca.llistat.accio.variables"/>&nbsp;<span class="badge">{{:campsCount}}</span></a>
						</script>
					</th>
					<th data-col-name="documentsCount" data-template="#cellDocumentsTemplate" data-orderable="false" width="13%">
						<script id="cellDocumentsTemplate" type="text/x-jsrender">
							<a href="<c:url value='/definicioProces'/>/${jbpmKey}/${definicioProcesId}/tasca/{{:id}}/document" data-toggle="modal" data-callback="callbackModalTasques()" class="btn btn-default"><spring:message code="definicio.proces.tasca.llistat.accio.documents"/>&nbsp;<span class="badge">{{:documentsCount}}</span></a>
						</script>
					</th>
					<th data-col-name="firmesCount" data-template="#cellSignaturesTemplate" data-orderable="false" width="13%">
						<script id="cellSignaturesTemplate" type="text/x-jsrender">
							<a href="<c:url value='/definicioProces'/>/${jbpmKey}/${definicioProcesId}/tasca/{{:id}}/firma" data-toggle="modal" data-callback="callbackModalTasques()" class="btn btn-default"><spring:message code="definicio.proces.tasca.llistat.accio.signatures"/>&nbsp;<span class="badge">{{:firmesCount}}</span></a>
						</script>
					</th>
					<th data-col-name="id" data-template="#cellAccionsTascaTemplate" data-orderable="false" width="10%">
						<script id="cellAccionsTascaTemplate" type="text/x-jsrender">
							<a class="btn btn-default" data-toggle="modal" data-callback="callbackModalTasques()" href="<c:url value='/definicioProces'/>/${jbpmKey}/${definicioProcesId}/tasca/{{:id}}/update"><span class="fa fa-pencil"></span>&nbsp;<spring:message code="comu.boto.modificar"/></a>
						</script>
					</th>
				</tr>
			</thead>
		</table>
		<script id="rowhrefTemplateTasques" type="text/x-jsrender"><c:url value='/definicioProces'/>/${jbpmKey}/${definicioProcesId}/tasca/{{:id}}/update</script>
	</c:when>
	<c:otherwise>
