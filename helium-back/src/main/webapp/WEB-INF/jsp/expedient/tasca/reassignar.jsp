...
<body>
	<form:form action="reassignar" method="post" modelAttribute="expedientTascaReassignarCommand" onsubmit="return confirmarReassignar(event)">
		...
		<div class="ctrlHolder">
			<div id="duser">
				<hel:inputSuggest required="true" name="usuari" urlConsultaInicial="/persona/suggestInici" urlConsultaLlistat="/expedient/persona/suggest" textKey="expedient.editar.responsable" placeholderKey="expedient.editar.responsable"/>
			</div>
			<div id="dgrup">
