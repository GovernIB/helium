...
<body>		
	<form:form id="aturarExpedient" name="aturarExpedient" action="aturar" method="post" modelAttribute="expedientEinesAturarCommand" onsubmit="return confirmar(event)">
