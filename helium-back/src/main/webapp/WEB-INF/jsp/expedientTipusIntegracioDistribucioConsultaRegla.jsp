				...
				<dd>
					<c:choose>
						<c:when test="${regla.activa}">
							<span class="fa fa-check" style="color:green;"></span>
							<a id="canviEstatReglaBtn" href="<c:url value="/expedientTipus/${expedientTipusId}/integracioDistribucio/canviEstatRegla?codiProcediment=${codiProcediment}&activa=false"></c:url>" class="btn btn-xs btn-default btn-load" style="margin-left: 10px;">
						...
						<c:otherwise>
							<span class="fa fa-close" style="color:red;"></span>
							<a id="canviEstatReglaBtn" href="<c:url value="/expedientTipus/${expedientTipusId}/integracioDistribucio/canviEstatRegla?codiProcediment=${codiProcediment}&activa=true"></c:url>" class="btn btn-xs btn-default btn-load" style="margin-left: 10px;">
