...
<script type="text/javascript">
	...
	function reestructura (proces, correcte) {
		if (correcte) {
			...
			panell.load('<c:url value="/nodeco/expedient/${expedientId}/proces/"/>' + proces + '/dada', {"ambOcults": ambOcults}, updatePanell);
		}
	};
		...
		<c:if test="${estatsAvancar != null }">
			<div style="float: right;">
				<c:forEach var="estat" items="${estatsAvancar}">
					<a href="<c:url value="/expedient/${expedientId}/estat/${estat.id}/canviar" />" class="btn btn-success" style="margin-right: 15px;">
	...
	<%-- 						<c:if test="${expedient.permisWrite}"><span class="fa fa-pencil edita" onclick="$('#canviDefinicioProcesJbpm').toggleClass('hide');" style="cursor: pointer"></span></c:if> --%>
		...
		<div id="expedient-pipelles" class="col-md-9">
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li id="pipella-signatures"><a href="#contingut-signatures" role="tab" data-toggle="tab"><spring:message code="expedient.info.pipella.signatura"/></a></li>
			...
			<div class="tab-content">
				...
				<div id="contingut-documents" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/document"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				...
				<div id="contingut-terminis" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/termini"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<c:if test="${not perEstats}">
					<div id="contingut-tasques" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/tasca"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<c:if test="${expedient.permisTokenRead and not perEstats}">
					<div id="contingut-tokens" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/token"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<c:if test="${expedient.permisLogRead and not perEstats}">
					<div id="contingut-registre" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/registre"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<c:if test="${perEstats}">
					<div id="contingut-estats" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/estat"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<c:if test="${numAccions > 0}">
					<div id="contingut-accions" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/accio"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<c:if test="${expedient.tipus.notibActiu}">
					<div id="contingut-notificacions" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/notificacions"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<div id="contingut-signatures" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/signatures"/>">
					<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
				</div>
				<c:if test="${expedient.tipus.distribucioActiu}">
					<div id="contingut-anotacions" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/anotacio"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
				<c:if test="${numPinbals > 0}">
					<div id="contingut-pinbal" class="tab-pane" data-href="<c:url value="/nodeco/expedient/${expedient.id}/pinbal"/>">
						<div class="contingut-carregant"><span class="fa fa-circle-o-notch fa-spin fa-3x"></span></div>
					</div>
				</c:if>
			</div>
