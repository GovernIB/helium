...
<body id="diseny-body">
	...
	<div style="height: 100px">
		<div class="floating-form" title="Arrossegar per afegir el camp">
			<form:form id="tasca-camp-form" cssClass="well" action="${baseModalUrl}/variable/new" enctype="multipart/form-data" method="post" modelAttribute="definicioProcesTascaVariableCommand" draggable="true" ondragstart="dragstartHandler(event)">
