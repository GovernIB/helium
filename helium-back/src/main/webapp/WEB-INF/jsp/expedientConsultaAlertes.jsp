		...
		<script type="text/javascript">
			...
			$('#alertaErrorsReindexacio').click(function(){
				...
				if (!errorsCarregats) {
					...
					$('#collapseErrorsReindexacio').load('<c:url value="/nodeco/reindexacions/tipus/${tipusId}/expedientsErrorsReindexacio"/>', 
						function() {
			...
			$('#alertaPendentsReindexacio').click(function(){
				...
				if (!pendentsCarregats) {
					...
					$('#collapsePendentsReindexacio').load('<c:url value="/nodeco/reindexacions/tipus/${tipusId}/expedientsPendentsReindexacio"/>', function() {
