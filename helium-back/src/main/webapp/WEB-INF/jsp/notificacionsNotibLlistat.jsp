			...
			<div class="col-md-12 pull-right">
				<div class="pull-right">
						<div id="btnTramitacio" class="btn-group">
							<a id="btnBdades" class="btn btn-default" href="../notificacionsNotib/descarregardades"><span class="fa fa-download"></span> <spring:message code="expedient.llistat.accio.descarregar"/></a>
						</div>
