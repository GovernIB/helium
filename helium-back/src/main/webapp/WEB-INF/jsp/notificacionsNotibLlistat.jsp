...
<body>
	<form:form action="" method="post" cssClass="well" modelAttribute="notificacioFiltreCommand">
			...
			<div class="col-md-12 pull-right">
				<div class="pull-right">
						<div id="btnTramitacio" class="btn-group">
							<c:url value="/notificacionsNotib/descarregardades" var="descarregaDadesUrl"/>
							<a id="btnBdades" class="btn btn-default" href="${descarregaDadesUrl}"><span class="fa fa-download"></span> <spring:message code="expedient.llistat.accio.descarregar"/></a>
						</div>
...
(Entorn {{:entornCodi}} - {{:entornNom}})"></span>
				...
				<th data-col-name="expedient.identificador" data-template="#cellExpTemplate" width="20%"><spring:message code="consultes.pinbal.camp.exp"/>
					<script id="cellExpTemplate" type="text/x-jsrender">
						<a href="<c:url value="/expedient/{{:expedientId}}"/>" target="_blank">{{:expedient.identificador}}</a>
					</script>
				</th>
				...
				<spring:message code="notificacio.llistat.filtre.camp.document.nom"/>
					<script id="cellDocTemplate" type="text/x-jsrender">
						<a href="<c:url value="/expedient/{{:expedientId}}/proces/{{:processInstanceId}}/document/{{:documentStoreId}}/descarregar"/>"
				...
				<th data-col-name="justificantArxiuNom" data-template="#cellJustificantTemplate" width="8%" data-orderable="false">
					...
					<script id="cellJustificantTemplate" type="text/x-jsrender">
						{{if justificantId != null}}
							<a href="<c:url value="/expedient/{{:expedientId}}/proces/{{:processInstanceId}}/document/{{:justificantId}}/descarregar"/>"
								title="<spring:message code="expedient.notificacio.descarregar.doc"/> ${arxiuNom}"
								target="_blank">
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown navbar-right">
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/notificacionsNotib/{{:id}}/info"/>" data-toggle="modal" class="consultar-expedient"><span class="fa fa-info-circle"></span>&nbsp;<spring:message code="consultes.pinbal.boto.info"/></a></li>
								<li><a href="<c:url value="/notificacionsNotib/{{:id}}/consultarEstat"/>"
	...
	<script id="rowhrefTemplate" type="text/x-jsrender"><c:url value="/notificacionsNotib/{{:id}}/info"/></script>
