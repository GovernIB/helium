...
<c:set var="modalPrefix" value="/modal"/>
								...
								<td class="columna-info-tasca">
									...
									<div class="pull-right">
										...
										<c:if test="${not tasca.completed and tasca.tascaTramitacioMassiva}">
											<c:choose>
												<c:when test="${tasca.assignadaUsuariActual}"><a href="${modalPrefix}/tasca/${tasca.id}/massiva"><span class="label label-default" title="<spring:message code="tasca.llistat.accio.tramitar_massivament"/>"><i class="fa fa-files-o"></i></span></a></c:when>
										...
										<c:if test="${not empty tasca.errorFinalitzacio or not empty tasca.marcadaFinalitzar or not empty tasca.iniciFinalitzacio}">
											<div class="pull-right">
												<a class="segon-pla-link" data-rdt-link-modal="true" href="<c:url value="/modal/expedient/${expedient.id}/execucioInfo/${tasca.id}"/>">
											...
											<div class="btn-group">
												...
												<ul id="dropdown-menu-tasca-${tasca.id}" class="dropdown-menu">
													<c:if test="${tasca.open and not tasca.suspended and tasca.assignee == dadesPersona.codi and tasca.assignadaUsuariActual}">
														<li><a id="tramitar-tasca-${tasca.id}" href="<c:url value="${modalPrefix}/tasca/${tasca.id}"/>" class="icon" data-rdt-link-callback="refrescarPanell(${expedient.id},${tasca.id},false);" data-rdt-link-modal="true" data-rdt-link-modal-maximize="true"><span class="fa fa-folder-open"></span> <spring:message code="tasca.llistat.accio.tramitar"/></a></li>
														<c:if test="${tasca.tascaTramitacioMassiva}">
															<li><a href="${modalPrefix}/tasca/${tasca.id}/massiva"><span class="fa fa-files-o"></span> <spring:message code="tasca.llistat.accio.tramitar_massivament"/></a></li>
														</c:if>
													</c:if>
