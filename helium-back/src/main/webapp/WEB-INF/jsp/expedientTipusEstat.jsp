...
<c:url var="urlDatatable" value="/expedientTipus/${expedientTipus.id}/estats/datatable"/>
<c:choose>
		...
		<table	id="expedientTipusEstat"
			...
			<thead>
				<tr>
					...
					<th data-col-name="reglesCount" data-template="#cellReglesTemplate" data-orderable="false" width="8%">
...
function canviarPosicioEstat(id, pos) {
	...
	var getUrl = '<c:url value="/expedientTipus/${expedientTipusId}/estat/"/>'+id+'/moure/'+pos;
		$.ajax({
			type: 'GET',
			url: getUrl,
			async: true,
