...
<body>
	<form:form id="desplegar-form" cssClass="form-horizontal" action="new" enctype="multipart/form-data" method="post" modelAttribute="command" style="min-height: 200px;">
		...
		<input type="hidden" name="accio" id="accio" value="${command.accio}" />
		<div class="form-group">
			...
			<div class="col-xs-8">
				<input type="file" name="file" id="file" accept=".jar,.zip,.class" />
