...
<body>
	<div class="text-right" data-toggle="botons-titol">
		<a href="<c:url value="/unitatOrganitzativa/mostrarArbre"/>" data-toggle="modal"  class="btn btn-default"><span class="fa fa-sitemap"></span> <spring:message code="unitat.organitzativa.list.boto.mostrarArbre"/></a>
		<c:if test="${dadesPersona.admin}">
			<a href="<c:url value="/unitatOrganitzativa/synchronizeGet"/>" data-toggle="modal" class="btn btn-default"><span class="fa fa-refresh"></span> <spring:message code="unitat.organitzativa.list.boto.synchronize"/></a>
		</c:if>
	</div>
	<form:form action="" method="post" cssClass="well" modelAttribute="unitatOrganitzativaCommand">
		<div class="row">
			<div class="col-md-2">
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown navbar-right">
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/unitatOrganitzativa/{{:id}}/info"/>" data-toggle="modal" class="consultar-expedient"><span class="fa fa-info-circle"></span>&nbsp;<spring:message code="unitat.organitzativa.controller.boto.info"/></a></li>
							</ul>
						</div>
					</script>
				</th>
