...
<c:set var="baseUrl"><c:url value="/modal/expedientTipus/${expedientTipusId}/consulta/${consulta.id}/parametre"></c:url></c:set>
...
<body>			
	...
	<form:form id="parametre-form" cssClass="form-horizontal" action="#" enctype="multipart/form-data" method="post" modelAttribute="expedientTipusConsultaParamCommand" 
