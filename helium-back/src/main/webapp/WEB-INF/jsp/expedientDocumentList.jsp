...
<script type="application/javascript">
	...
	var urlDescarregaBase = '<c:url value="/nodeco/expedient/${expedient.id}/document/"/>';
...
<c:url var="urlDatatable" value="/expedient/${expedient.id}/document/datatable"/>
...
<script id="tableButtonsDocumentsTemplate" type="text/x-jsrender">
	<div class="botons-titol text-right">
		...
		<a id="descarregarZip" href="<c:url value="/expedient/${expedient.id}/document/descarregar"/>" class="btn btn-default" title="<spring:message code="expedient.document.descarregar.zip"/>">
