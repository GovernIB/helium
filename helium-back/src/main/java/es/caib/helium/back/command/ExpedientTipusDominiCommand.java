...
import es.caib.helium.back.command.ExpedientTipusDominiCommand.Creacio;
import es.caib.helium.back.command.ExpedientTipusDominiCommand.Modificacio;
import es.caib.helium.back.validator.Codi;
import es.caib.helium.back.validator.ExpedientTipusDomini;
import es.caib.helium.commons.dto.DominiDto.OrigenCredencials;
import es.caib.helium.commons.dto.DominiDto.TipusAuthDomini;
