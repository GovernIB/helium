...
import es.caib.helium.back.command.ExpedientEinesAnularCommand;
...
//				params[2] = rols;
	...
	@RequestMapping(value = "/{campIdentificador}/camp/{campId}/valorsSeleccio", method = RequestMethod.GET)
	@ResponseBody
	public List<SeleccioOpcioDto> valorsSeleccio(
			HttpServletRequest request,
			@PathVariable Long campIdentificador,
			@PathVariable Long campId,
			Model model) {
	...
	@RequestMapping(value = "/{campIdentificador}/camp/{campId}/valorsSeleccio/{valor}", method = RequestMethod.GET)
	@ResponseBody
	public List<SeleccioOpcioDto> valorsSeleccio(
			HttpServletRequest request,
			@PathVariable Long campIdentificador,
