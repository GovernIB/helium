...
import es.caib.helium.back.command.CampCommand.Creacio;
import es.caib.helium.back.command.CampCommand.Modificacio;
import es.caib.helium.back.validator.Camp;
