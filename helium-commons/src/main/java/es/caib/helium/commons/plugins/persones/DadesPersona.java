 ...
 * 
 */
package es.caib.helium.commons.plugins.persones;
...
public class DadesPersona implements Serializable {
	...
	public DadesPersona(String codi, String nomSencer, String email, Sexe sexe) {
		this.codi = codi;
		this.setNomSencer(nomSencer);
		this.email = email;
		this.sexe = sexe;
	}
	public DadesPersona(String codi, String nom, String llinatges, String email, Sexe sexe) {
		this.codi = codi;
		this.setNom(nom);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DadesPersona other = (DadesPersona) obj;
		if (codi == null) {
			if (other.codi != null)
				return false;
