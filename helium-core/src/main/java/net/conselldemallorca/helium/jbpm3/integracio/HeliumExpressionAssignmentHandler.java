...
public class HeliumExpressionAssignmentHandler implements AssignmentHandler {
	...
	private PersonaDto getPersonaAmbCodi(String codi) {
		PersonaDto p = DaoProxy.getInstance().getPluginPersonaDao().findAmbCodiPlugin(codi);
		if (p == null)
	...
	private PersonaDto getPersonaAmbAreaICarrec(Long entornId, String codiArea, String codiCarrec) {
