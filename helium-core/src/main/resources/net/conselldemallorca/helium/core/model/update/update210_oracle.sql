...
ALTER TABLE HEL_VERSIO ADD PROCES_EXECUTAT NUMBER(1) DEFAULT 0;
ALTER TABLE HEL_VERSIO ADD DATA_EXECUCIO_PROCES TIMESTAMP(6);
ALTER TABLE HEL_VERSIO ADD SCRIPT_EXECUTAT NUMBER(1) DEFAULT 0;
...
ALTER TABLE HEL_TERMINI
 ADD (ALERTA_COMPLETAT        NUMBER(1) DEFAULT 0);
...
ALTER TABLE HEL_ENUMERACIO
 ADD CONSTRAINT HEL_EXPTIP_ENUMERACIO_FK FOREIGN KEY (EXPEDIENT_TIPUS_ID) REFERENCES
        HEL_EXPEDIENT_TIPUS (ID);

-- Anulació d'expedients --
ALTER TABLE HEL_EXPEDIENT
 ADD (ANULAT        NUMBER(1) DEFAULT 0);
