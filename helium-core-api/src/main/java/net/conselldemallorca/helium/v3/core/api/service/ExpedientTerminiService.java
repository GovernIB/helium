...
public interface ExpedientTerminiService {
	...
	public void pausar(
			...
			Date data) throws NoTrobatException, ValidacioException;
	...
	public List<TerminiIniciatDto> findIniciatsAmbProcessInstanceId(
			String processInstanceId);

	public List<TerminiDto> findTerminisAmbProcessInstanceId(
			String processInstanceId) throws NoTrobatException;

	public TerminiIniciatDto findIniciatAmbId(
	...
	public List<FestiuDto> findFestiuAmbAny(
			int any);

	public void createFestiu(
			String data) throws Exception;

	public void deleteFestiu(
