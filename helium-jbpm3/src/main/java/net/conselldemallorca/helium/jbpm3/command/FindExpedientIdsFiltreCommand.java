...
public class FindExpedientIdsFiltreCommand extends AbstractBaseCommand {
	...
	private boolean permesTasquesAltresUsuaris;
	...
	public FindExpedientIdsFiltreCommand(
		...
		this.permesTasquesAltresUsuaris = permesTasquesAltresUsuaris;
	...
	private void setQueryParams(
		...
		if (nomesAmbTasquesPendents && !permesTasquesAltresUsuaris) {
