		...
		transactionTemplate.execute(new TransactionCallback() {
			public Object doInTransaction(TransactionStatus transactionStatus) {
				try {
					...
					// Hem configurat la transacció de updateExpedientError per a que es desi tot i fer rollback...
					...
					// Anam a provocar la excepció des d'aquí, per a forçar el rollback...
