...
public class UpdateResponse  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateResponseDocument document;
    ...
    public UpdateResponse(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateResponseDocument document,
     ...
     * @return document
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateResponseDocument getDocument() {
        return document;
    }
     ...
     * @param document
     */
    public void setDocument(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateResponseDocument document) {
        this.document = document;
    }
