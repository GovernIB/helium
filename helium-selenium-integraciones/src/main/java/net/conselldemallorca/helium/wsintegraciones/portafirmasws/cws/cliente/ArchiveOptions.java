...
public class ArchiveOptions  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] sourceLocators;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] destinationLocators;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveMetadata[] archiveMetadatas;

    public ArchiveOptions() {
    }

    public ArchiveOptions(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] sourceLocators,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] destinationLocators,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveMetadata[] archiveMetadatas) {
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] getSourceLocators() {
        return sourceLocators;
    }
     ...
     */
    public void setSourceLocators(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] sourceLocators) {
        this.sourceLocators = sourceLocators;
    }
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] getDestinationLocators() {
        return destinationLocators;
    }
     ...
     */
    public void setDestinationLocators(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveLocator[] destinationLocators) {
        this.destinationLocators = destinationLocators;
    }
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveMetadata[] getArchiveMetadatas() {
        return archiveMetadatas;
    }
     ...
     */
    public void setArchiveMetadatas(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ArchiveMetadata[] archiveMetadatas) {
        this.archiveMetadatas = archiveMetadatas;
    }
