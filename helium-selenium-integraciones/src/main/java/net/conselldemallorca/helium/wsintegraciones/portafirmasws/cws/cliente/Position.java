...
public class Position  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeEnum source;

    private java.lang.String reference;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfTypeEnum type;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfPosition pdfPosition;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImageDimensions signatureImageDimensions;

    public Position() {
    }

    public Position(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeEnum source,
           java.lang.String reference,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfTypeEnum type,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfPosition pdfPosition,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImageDimensions signatureImageDimensions) {
           this.source = source;
     ...
     * @return source
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeEnum getSource() {
        return source;
    }
     ...
     * @param source
     */
    public void setSource(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeEnum source) {
        this.source = source;
    }
     ...
     * @return type
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfTypeEnum getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfTypeEnum type) {
        this.type = type;
    }
     ...
     * @return pdfPosition
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfPosition getPdfPosition() {
        return pdfPosition;
    }
     ...
     * @param pdfPosition
     */
    public void setPdfPosition(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PdfPosition pdfPosition) {
        this.pdfPosition = pdfPosition;
    }
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImageDimensions getSignatureImageDimensions() {
        return signatureImageDimensions;
    }
     ...
     */
    public void setSignatureImageDimensions(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImageDimensions signatureImageDimensions) {
        this.signatureImageDimensions = signatureImageDimensions;
    }
