...
public class MCGDWSSoapBindingStub extends org.apache.axis.client.Stub implements net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.MCGDws {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.indra.es/portafirmasmcgdws/mcgdws", "callback-request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.indra.es/portafirmasmcgdws/mcgdws", ">callback-request"), net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.CallbackRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.indra.es/portafirmasmcgdws/mcgdws", ">callback-response"));
        oper.setReturnClass(net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.CallbackResponse.class);
    ...
    public MCGDWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.AttributesState.class;
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.CallbackRequest.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.CallbackResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Application.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.LogMessage[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Attributes.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Certificate.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Delegate.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Document.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Rejection.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Signer.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {callbackRequest});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.CallbackResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.CallbackResponse) org.apache.axis.utils.JavaUtils.convert(_resp, net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.CallbackResponse.class);
            }
        }
