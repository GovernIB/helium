...
public class DownloadOptions  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ModeTypeEnum downloadType;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.File[] files;

    public DownloadOptions() {
    }

    public DownloadOptions(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ModeTypeEnum downloadType,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.File[] files) {
     ...
     * @return downloadType
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ModeTypeEnum getDownloadType() {
        return downloadType;
    }
     ...
     * @param downloadType
     */
    public void setDownloadType(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ModeTypeEnum downloadType) {
        this.downloadType = downloadType;
    }
     ...
     * @return files
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.File[] getFiles() {
        return files;
    }
     ...
     * @param files
     */
    public void setFiles(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.File[] files) {
        this.files = files;
    }
