...
public class ListTypeResponse  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeDocument[] types;
    ...
    public ListTypeResponse(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeDocument[] types,
     ...
     * @return types
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeDocument[] getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.TypeDocument[] types) {
        this.types = types;
    }
