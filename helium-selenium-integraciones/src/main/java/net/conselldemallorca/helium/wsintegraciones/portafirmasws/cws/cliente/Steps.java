...
public class Steps  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignModeEnum signMode;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step[] step;

    public Steps() {
    }

    public Steps(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignModeEnum signMode,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step[] step) {
     ...
     * @return signMode
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignModeEnum getSignMode() {
        return signMode;
    }
     ...
     * @param signMode
     */
    public void setSignMode(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignModeEnum signMode) {
        this.signMode = signMode;
    }
     ...
     * @return step
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step[] getStep() {
        return step;
    }
     ...
     * @param step
     */
    public void setStep(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step[] step) {
        this.step = step;
    }

    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step getStep(int i) {
        return this.step[i];
    }

    public void setStep(int i, net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step _value) {
        this.step[i] = _value;
    }
