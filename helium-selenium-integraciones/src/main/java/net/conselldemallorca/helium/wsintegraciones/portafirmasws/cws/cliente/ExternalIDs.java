...
public class ExternalIDs  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.VerificationCode verificationCode;
    ...
    public ExternalIDs(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.VerificationCode verificationCode) {
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.VerificationCode getVerificationCode() {
        return verificationCode;
    }
     ...
     */
    public void setVerificationCode(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.VerificationCode verificationCode) {
        this.verificationCode = verificationCode;
    }
