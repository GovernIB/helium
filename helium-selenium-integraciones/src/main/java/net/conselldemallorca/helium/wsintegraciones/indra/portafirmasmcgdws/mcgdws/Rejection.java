...
import net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Rejection;
...
public class Rejection  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.indra.es/portafirmasmcgdws/mcgdws", "Rejection"));
