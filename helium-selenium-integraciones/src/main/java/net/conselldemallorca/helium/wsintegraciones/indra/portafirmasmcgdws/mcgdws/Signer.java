...
import net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Signer;
...
public class Signer  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Delegate delegate;

    private net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Certificate certificate;

    private net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Rejection rejection;
    ...
    public Signer(
           ...
           net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Delegate delegate,
           net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Certificate certificate,
           net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Rejection rejection) {
           this.id = id;
           this.date = date;
     ...
     * @return delegate
     */
    public net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Delegate getDelegate() {
        return delegate;
    }
     ...
     * @param delegate
     */
    public void setDelegate(net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Delegate delegate) {
        this.delegate = delegate;
    }
     ...
     * @return certificate
     */
    public net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Certificate getCertificate() {
        return certificate;
    }
     ...
     * @param certificate
     */
    public void setCertificate(net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Certificate certificate) {
        this.certificate = certificate;
    }
     ...
     * @return rejection
     */
    public net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Rejection getRejection() {
        return rejection;
    }
     ...
     * @param rejection
     */
    public void setRejection(net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Rejection rejection) {
        this.rejection = rejection;
    }
