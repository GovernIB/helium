...
public class UpdateRequest  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateRequestDocument document;
    ...
    public UpdateRequest(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateRequestDocument document,
     ...
     * @return document
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateRequestDocument getDocument() {
        return document;
    }
     ...
     * @param document
     */
    public void setDocument(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UpdateRequestDocument document) {
        this.document = document;
    }
