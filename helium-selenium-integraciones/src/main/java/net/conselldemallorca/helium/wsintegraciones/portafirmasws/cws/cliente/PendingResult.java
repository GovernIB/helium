...
public class PendingResult  extends net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SearchResult  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PendingDocuments pendingDocuments;

    public PendingResult() {
    }

    public PendingResult(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PendingDocuments pendingDocuments) {
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PendingDocuments getPendingDocuments() {
        return pendingDocuments;
    }
     ...
     */
    public void setPendingDocuments(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.PendingDocuments pendingDocuments) {
        this.pendingDocuments = pendingDocuments;
    }
