...
public class DownloadFileRequestDocument  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadOptions downloadOptions;
    ...
    public DownloadFileRequestDocument(
           int id,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadOptions downloadOptions) {
           this.id = id;
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadOptions getDownloadOptions() {
        return downloadOptions;
    }
     ...
     */
    public void setDownloadOptions(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadOptions downloadOptions) {
        this.downloadOptions = downloadOptions;
    }
