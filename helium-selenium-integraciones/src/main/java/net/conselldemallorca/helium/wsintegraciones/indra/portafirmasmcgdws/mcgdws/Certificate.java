...
import net.conselldemallorca.helium.wsintegraciones.indra.portafirmasmcgdws.mcgdws.Certificate;
...
public class Certificate  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.indra.es/portafirmasmcgdws/mcgdws", "Certificate"));
