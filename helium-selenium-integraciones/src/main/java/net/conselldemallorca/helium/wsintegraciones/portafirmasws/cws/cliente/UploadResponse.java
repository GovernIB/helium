...
public class UploadResponse  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UploadResponseDocument document;
    ...
    public UploadResponse(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UploadResponseDocument document,
     ...
     * @return document
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UploadResponseDocument getDocument() {
        return document;
    }
     ...
     * @param document
     */
    public void setDocument(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.UploadResponseDocument document) {
        this.document = document;
    }
