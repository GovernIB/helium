...
public class DeleteResponse  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DeleteResponseDocument[] documents;
    ...
    public DeleteResponse(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DeleteResponseDocument[] documents,
     ...
     * @return documents
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DeleteResponseDocument[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DeleteResponseDocument[] documents) {
        this.documents = documents;
    }
