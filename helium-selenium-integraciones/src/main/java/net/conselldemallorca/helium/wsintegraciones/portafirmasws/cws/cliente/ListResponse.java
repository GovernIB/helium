...
public class ListResponse  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ListResponseDocument[] documents;
    ...
    public ListResponse(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ListResponseDocument[] documents,
     ...
     * @return documents
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ListResponseDocument[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.ListResponseDocument[] documents) {
        this.documents = documents;
    }
