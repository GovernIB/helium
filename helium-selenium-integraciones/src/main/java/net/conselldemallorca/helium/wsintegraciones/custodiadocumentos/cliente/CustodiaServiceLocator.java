...
public class CustodiaServiceLocator extends org.apache.axis.client.Service implements net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.CustodiaService {
    ...
    public net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.Custodia getCustodiaDocumentos() throws javax.xml.rpc.ServiceException {
    ...
    public net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.Custodia getCustodiaDocumentos(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.CustodiaDocumentosSoapBindingStub _stub = new net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.CustodiaDocumentosSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.Custodia.class.isAssignableFrom(serviceEndpointInterface)) {
                net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.CustodiaDocumentosSoapBindingStub _stub = new net.conselldemallorca.helium.wsintegraciones.custodiadocumentos.cliente.CustodiaDocumentosSoapBindingStub(new java.net.URL(CustodiaDocumentos_address), this);
                _stub.setPortName(getCustodiaDocumentosWSDDServiceName());
                return _stub;
            }
        }
