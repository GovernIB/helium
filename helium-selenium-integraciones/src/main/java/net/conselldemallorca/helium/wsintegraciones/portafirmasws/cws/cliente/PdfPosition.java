...
public class PdfPosition  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Format format;
    ...
    public PdfPosition(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Format format,
     ...
     * @return format
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Format getFormat() {
        return format;
    }
     ...
     * @param format
     */
    public void setFormat(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Format format) {
        this.format = format;
    }
