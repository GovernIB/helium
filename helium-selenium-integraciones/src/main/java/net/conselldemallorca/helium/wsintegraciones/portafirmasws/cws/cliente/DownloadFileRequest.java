...
public class DownloadFileRequest  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadFileRequestDocument document;
    ...
    public DownloadFileRequest(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadFileRequestDocument document,
     ...
     * @return document
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadFileRequestDocument getDocument() {
        return document;
    }
     ...
     * @param document
     */
    public void setDocument(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadFileRequestDocument document) {
        this.document = document;
    }
