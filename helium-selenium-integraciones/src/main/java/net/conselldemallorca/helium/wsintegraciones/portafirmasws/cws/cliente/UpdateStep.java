...
public class UpdateStep  extends net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signers;

    public UpdateStep() {
    }

    public UpdateStep(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signers) {
     ...
     * @return signers
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] getSigners() {
        return signers;
    }
     ...
     * @param signers
     */
    public void setSigners(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signers) {
        this.signers = signers;
    }
