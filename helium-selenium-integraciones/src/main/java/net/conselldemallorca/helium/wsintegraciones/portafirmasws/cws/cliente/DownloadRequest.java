...
public class DownloadRequest  implements java.io.Serializable {
    ...
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadRequestDocument document;
    ...
    public DownloadRequest(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadRequestDocument document,
     ...
     * @return document
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadRequestDocument getDocument() {
        return document;
    }
     ...
     * @param document
     */
    public void setDocument(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.DownloadRequestDocument document) {
        this.document = document;
    }
