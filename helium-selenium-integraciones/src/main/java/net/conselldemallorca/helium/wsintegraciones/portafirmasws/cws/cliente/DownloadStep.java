...
public class DownloadStep  extends net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Step  implements java.io.Serializable {
    private java.lang.Integer minimalSigners;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersAction;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersReject;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersNone;
    ...
    public DownloadStep(
           ...
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersAction,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersReject,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersNone) {
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] getSignersAction() {
        return signersAction;
    }
     ...
     * @param signersAction
     */
    public void setSignersAction(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersAction) {
        this.signersAction = signersAction;
    }
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] getSignersReject() {
        return signersReject;
    }
     ...
     * @param signersReject
     */
    public void setSignersReject(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersReject) {
        this.signersReject = signersReject;
    }
     ...
     * @return signersNone
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] getSignersNone() {
        return signersNone;
    }
     ...
     * @param signersNone
     */
    public void setSignersNone(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Signer[] signersNone) {
        this.signersNone = signersNone;
    }
