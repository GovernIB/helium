...
public class PdfAppearance  implements java.io.Serializable {
    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImage signatureImage;

    private net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Position[] positions;

    public PdfAppearance() {
    }

    public PdfAppearance(
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImage signatureImage,
           net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Position[] positions) {
     ...
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImage getSignatureImage() {
        return signatureImage;
    }
     ...
     */
    public void setSignatureImage(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.SignatureImage signatureImage) {
        this.signatureImage = signatureImage;
    }
     ...
     * @return positions
     */
    public net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Position[] getPositions() {
        return positions;
    }
     ...
     * @param positions
     */
    public void setPositions(net.conselldemallorca.helium.wsintegraciones.portafirmasws.cws.cliente.Position[] positions) {
        this.positions = positions;
    }
