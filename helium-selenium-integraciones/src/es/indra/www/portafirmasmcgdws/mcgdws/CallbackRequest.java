...
public class CallbackRequest  implements java.io.Serializable {
    private es.indra.www.portafirmasmcgdws.mcgdws.Application application;
    ...
    public CallbackRequest(
           es.indra.www.portafirmasmcgdws.mcgdws.Application application,
     ...
     * @return application
     */
    public es.indra.www.portafirmasmcgdws.mcgdws.Application getApplication() {
        return application;
    }
     ...
     * @param application
     */
    public void setApplication(es.indra.www.portafirmasmcgdws.mcgdws.Application application) {
        this.application = application;
    }
