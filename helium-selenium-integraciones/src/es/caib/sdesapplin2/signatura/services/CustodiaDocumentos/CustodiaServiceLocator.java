...
public class CustodiaServiceLocator extends org.apache.axis.client.Service implements es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.CustodiaService {
    ...
    public es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.Custodia getCustodiaDocumentos() throws javax.xml.rpc.ServiceException {
    ...
    public es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.Custodia getCustodiaDocumentos(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.CustodiaDocumentosSoapBindingStub _stub = new es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.CustodiaDocumentosSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.Custodia.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.CustodiaDocumentosSoapBindingStub _stub = new es.caib.sdesapplin2.signatura.services.CustodiaDocumentos.CustodiaDocumentosSoapBindingStub(new java.net.URL(CustodiaDocumentos_address), this);
                _stub.setPortName(getCustodiaDocumentosWSDDServiceName());
                return _stub;
            }
        }
