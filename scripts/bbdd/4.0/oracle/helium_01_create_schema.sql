...
(
  ...
  ENTORN_ID           NUMBER(19)                NOT NULL,
  EXPEDIENT_TIPUS_ID  NUMBER(19),
  HAS_START_TASK      NUMBER(1,0)               DEFAULT 0 NOT NULL,
  START_TASK_NAME     VARCHAR2(255 CHAR)
);
...
CREATE TABLE HEL_RECURS (
  ID                   NUMBER(19)         NOT NULL,
  NOM                  VARCHAR2(255 CHAR) NOT NULL,
  CLASSE               NUMBER(1)          NOT NULL,
  HANDLER              NUMBER(1)          NOT NULL,
  DATA_CREACIO         TIMESTAMP          NOT NULL,
  CONTINGUT            BLOB               NOT NULL,
  EXPEDIENT_TIPUS_ID   NUMBER(19)         NOT NULL,
  DEFINICIO_PROCES_ID  NUMBER(19)
);
