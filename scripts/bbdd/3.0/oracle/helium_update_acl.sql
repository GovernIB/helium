...
DECLARE
  CURSOR C is SELECT MAX(ID) FROM HEL_ACL_CLASS;
  VRESULT NUMBER;
  STMT VARCHAR2(1000);
BEGIN
  OPEN C;
...
DECLARE
  CURSOR C is SELECT MAX(ID) FROM HEL_ACL_ENTRY;
  VRESULT NUMBER;
  STMT VARCHAR2(1000);
BEGIN
  OPEN C;
...
DECLARE
  CURSOR C is SELECT MAX(ID) FROM HEL_ACL_OBJECT_IDENTITY;
  VRESULT NUMBER;
  STMT VARCHAR2(1000);
BEGIN
  OPEN C;
...
DECLARE
  CURSOR C is SELECT MAX(ID) FROM HEL_ACL_SID;
  VRESULT NUMBER;
  STMT VARCHAR2(1000);
BEGIN
  OPEN C;
