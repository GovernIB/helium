...
(
	ID					BIGINT               NOT NULL,
	CODI                VARCHAR(64)          NOT NULL,
	DOCUMENTIDENT		VARCHAR(256)		 NOT NULL,
	NOM					VARCHAR(255),
	...
	DIR3CODI 			VARCHAR(21),
	DIRECCIO 			VARCHAR(160),
	CODIDIRE 			VARCHAR(21),
	TIPUSDOCIDENT 		VARCHAR(8),
	RAOSOCIAL 			VARCHAR(256),
	ES_REPRESENTANT 	BOOLEAN DEFAULT false NOT NULL,
	REPRESENTAT 		BIGINT,
	REPRESENTANT 		BIGINT
);
...
CREATE TABLE HEL_ANOTACIO (
  ...
  ERROR_PROCESSAMENT        VARCHAR(1024)
);
