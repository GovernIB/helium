...
(
  ...
  CONSTRAINT HEL_ACLSID_UK UNIQUE(SID, PRINCIPAL)
);
CREATE TABLE HEL_ACL_CLASS
(
  ID BIGSERIAL PRIMARY KEY,
  CLASS VARCHAR(255) NOT NULL,
  CONSTRAINT HEL_ACLCLASS_UK UNIQUE(CLASS)
);
...
(
  ...
  CONSTRAINT HEL_ACLOID_UK UNIQUE(OBJECT_ID_CLASS, OBJECT_ID_IDENTITY),
  CONSTRAINT HEL_ACLOID_ACLOID_FK FOREIGN KEY(PARENT_OBJECT) REFERENCES HEL_ACL_OBJECT_IDENTITY(ID),
  CONSTRAINT HEL_ACLCLASS_ACLOID_FK FOREIGN KEY(OBJECT_ID_CLASS) REFERENCES HEL_ACL_CLASS(ID),
  CONSTRAINT HEL_ACLSID_ACLOID_FK FOREIGN KEY(OWNER_SID) REFERENCES HEL_ACL_SID(ID)
);
...
(
  ...
  CONSTRAINT HEL_ACLENTRY_UK UNIQUE(ACL_OBJECT_IDENTITY, ACE_ORDER),
  CONSTRAINT HEL_ACLOID_ACLENTRY_FK FOREIGN KEY(ACL_OBJECT_IDENTITY) REFERENCES HEL_ACL_OBJECT_IDENTITY(ID),
  CONSTRAINT HEL_ACLSID_ACLENTRY_FK FOREIGN KEY(SID) REFERENCES HEL_ACL_SID(ID)
);
