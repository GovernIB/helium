...
(
  ...
  EXPEDIENT_TIPUS_ID     BIGINT,
  IGNORED                BOOLEAN,
  NTI_TIPO_DOC           VARCHAR(32),
  NTI_TIPO_FIRMA         VARCHAR(64),
  NTI_VALOR_CSV          VARCHAR(128),
  NTI_DEFINICION_GENERACION_CSV     VARCHAR(128)
);
...
(
  ...
  SIGNAT               BOOLEAN,
  NTI_ACTIVO           BOOLEAN DEFAULT false,
  NTI_VERSIO           VARCHAR(256),
  NTI_IDENTIFICADOR    VARCHAR(107),
  NTI_ORGANO           VARCHAR(64),
  NTI_ORIGEN           VARCHAR(32),
  NTI_ESTADO_ELAB      VARCHAR(32),
  NTI_NOM_FORMAT       VARCHAR(16),
  NTI_TIPO_DOC         VARCHAR(32),
  NTI_TIPO_FIRMA       VARCHAR(64),
  NTI_VALOR_CSV        VARCHAR(128),
  NTI_DEFINICION_GENERACION_CSV     VARCHAR(128),
  NTI_ID_DOC_ORIGEN    VARCHAR(107)
);
...
(
  ...
  NTI_SERIEDOCUMENTAL  VARCHAR(64),
  NTI_IDENTIFICADOR    VARCHAR(107),
  NTI_TIPO_FIRMA       VARCHAR(64),
  NTI_VALOR_CSV        VARCHAR(128),
  NTI_DEFINICION_GENERACION_CSV       VARCHAR(128),
