...
ALTER TABLE HEL_EXPEDIENT_TIPUS MODIFY NTI_ORGANO VARCHAR(256);
ALTER TABLE HEL_EXPEDIENT_TIPUS MODIFY NTI_CLASIFICACION VARCHAR(44);
ALTER TABLE HEL_EXPEDIENT_TIPUS MODIFY NTI_SERIEDOCUMENTAL VARCHAR(16);
