...
(
  ...
  EXPEDIENT_TIPUS_ID     NUMBER(19),
  IGNORED                NUMBER(1),
  NTI_TIPO_DOC           VARCHAR2(32 CHAR),
  NTI_TIPO_FIRMA         VARCHAR2(64 CHAR),
  NTI_VALOR_CSV          VARCHAR2(128 CHAR),
  NTI_DEFINICION_GENERACION_CSV     VARCHAR2(128 CHAR)
);
...
(
  ...
  SIGNAT               NUMBER(1),
  NTI_ACTIVO           NUMBER(1) DEFAULT 0,
  NTI_VERSIO           VARCHAR2(256 CHAR),
  NTI_IDENTIFICADOR    VARCHAR2(107 CHAR),
  NTI_ORGANO           VARCHAR2(64 CHAR),
  NTI_ORIGEN           VARCHAR2(32 CHAR),
  NTI_ESTADO_ELAB      VARCHAR2(32 CHAR),
  NTI_NOM_FORMAT       VARCHAR2(16 CHAR),
  NTI_TIPO_DOC         VARCHAR2(32 CHAR),
  NTI_TIPO_FIRMA       VARCHAR2(64 CHAR),
  NTI_VALOR_CSV        VARCHAR2(128 CHAR),
  NTI_DEFINICION_GENERACION_CSV     VARCHAR2(128 CHAR),
  NTI_ID_DOC_ORIGEN    VARCHAR2(107 CHAR)
);
...
(
  ...
  NTI_VERSIO           VARCHAR2(256 CHAR),
  NTI_ORGANO           VARCHAR2(64 CHAR),
  NTI_CLASIFICACION    VARCHAR2(64 CHAR),
  NTI_SERIEDOCUMENTAL  VARCHAR2(64 CHAR),
  NTI_IDENTIFICADOR    VARCHAR2(107 CHAR),
  NTI_TIPO_FIRMA       VARCHAR2(64 CHAR),
  NTI_VALOR_CSV        VARCHAR2(128 CHAR),
  NTI_DEFINICION_GENERACION_CSV       VARCHAR2(128 CHAR),
...
(
  ...
  NTI_ACTIVO                NUMBER(1) DEFAULT 0,
  NTI_ORGANO                VARCHAR2(64),
  NTI_CLASIFICACION         VARCHAR2(64),
  NTI_SERIEDOCUMENTAL  VARCHAR2(64 CHAR),
  NTI_TIPO_FIRMA            VARCHAR2(64),
  NTI_VALOR_CSV             VARCHAR2(128),
  NTI_DEFINICION_GENERACION_CSV        VARCHAR2(128)
);
