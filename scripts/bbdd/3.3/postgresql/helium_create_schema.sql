...
(
  ...
  TIPUS                VARCHAR(32)        DEFAULT 'ACCIO' NOT NULL,
  CRON                 VARCHAR(255),
...
(
  ...
  DEFPROC_JBPMKEY	   VARCHAR(255),
  TERMINI_NOMES_DIES   BOOLEAN DEFAULT FALSE NOT NULL,
...
(
  ...
  ENTORN_ID            BIGINT               NOT NULL,
  TIPUS                BIGINT	DEFAULT 0 			NOT NULL,
  ...
  NTI_SERIEDOCUMENTAL       VARCHAR(16),
  ARXIU_ACTIU               BOOLEAN DEFAULT false,
  PROCEDIMENT_COMU          BOOLEAN DEFAULT false,
  ...
  DISTR_PRESENCIAL          BOOLEAN,
  DISTR_PROCES_AUTO			BOOLEAN DEFAULT FALSE,
  DISTR_SISTRA 				BOOLEAN DEFAULT FALSE,
  ENVIAR_CORREU_ANOTACIONS  BOOLEAN DEFAULT FALSE,
  MANUAL_AJUDA_CONTENT      BYTEA,
  MANUAL_AJUDA_NOM          VARCHAR(1024)
);
...
(
  ...
  TIPUS               BIGINT                NOT NULL,
  EXPEDIENT_TIPUS_ID  BIGINT                NOT NULL,
  NO_SOBREESCRIURE    BOOLEAN DEFAULT false
);
...
(
  ...
  CORREUS_BUSTIA BOOLEAN DEFAULT FALSE,
  CORREUS_BUSTIA_AGRUPATS_DIA BOOLEAN DEFAULT FALSE,
  EMAIL_ALTERNATIU VARCHAR(255),
  ENTORN_ACTUAL    VARCHAR(64),
  ENTORN_ACTUAL_DATA timestamp without time zone
;
...
CREATE TABLE HEL_ANOTACIO (
  ...
  ENTITAT_CODI 				character varying (21), 
  ...
  IDIOMA_CODI 				character varying (2), 
  ...
  OFICINA_CODI 				character varying (21), 
  ...
  DESTI_CODI 				character varying (21), 
  DESTI_DESCRIPCIO 			character varying (100),
  CONSULTA_INTENTS          BIGINT DEFAULT 0,
  CONSULTA_ERROR            VARCHAR(1024),
  CONSULTA_DATA             TIMESTAMP(6),
  ERROR_PROCESSAMENT        text,
  SERVEI_CODI 				VARCHAR(64 CHAR),
  PRESENCIAL 				BOOLEAN,
  TRAMIT_CODI 				VARCHAR(64 CHAR),
  TRAMIT_NOM 				VARCHAR(255 CHAR) 
);
...
(
  ...
  TIPUS 					VARCHAR(20 CHAR) DEFAULT 'PROCEDIMENT' NOT NULL
);
