...
ALTER TABLE HEL_EXPEDIENT ADD ESTATS_PREVIS VARCHAR2(1024 CHAR);

-- Permisos a l'usuari web
GRANT SELECT, UPDATE, INSERT, DELETE ON HEL_ESTAT_SORTIDA TO WWW_HELIUM;
