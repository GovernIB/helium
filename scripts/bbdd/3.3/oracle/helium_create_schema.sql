...
(
  ...
  DEFPROC_JBPMKEY	   VARCHAR2(255 CHAR),
  TERMINI_NOMES_DIES   NUMBER(1,0) DEFAULT 0 NOT NULL,
  INDEXABLE            NUMBER(1) DEFAULT 0 NOT NULL
);
...
(
  ...
  TIPUS               NUMBER(10)                NOT NULL,
  EXPEDIENT_TIPUS_ID  NUMBER(19)                NOT NULL,
  NO_SOBREESCRIURE	  NUMBER(1)					NOT NULL DEFAULT 0
);
...
CREATE TABLE HEL_ANOTACIO (
  ...
  TRAMIT_CODI				VARCHAR2(64 CHAR),
  TRAMIT_NOM				VARCHAR2(255 CHAR)
...
(
  ...
  TIPUS VARCHAR2(20 CHAR) DEFAULT 'PROCEDIMENT' NOT NULL
);
