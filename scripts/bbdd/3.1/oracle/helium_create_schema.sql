...
(
  ...
  CONSULTA_CAMP_TEXT   VARCHAR2(256),
  CONSULTA_CAMP_VALOR  VARCHAR2(256),
  CONSULTA_PARAMS      VARCHAR2(1020),
...
(
  ...
  NOTIFICACIO_ORGANCODI 	VARCHAR2(9 CHAR),
  NOTIFICACIO_OFICINACODI 	VARCHAR2(4 CHAR),
  NOTIFICACIO_UNITATADMIN 	VARCHAR2(9 CHAR),
  NOTIFICACIO_CODPROC 		VARCHAR2(30 CHAR),
  NOTIFICACIO_AVISTITOL 	VARCHAR2(256 CHAR),
  NOTIFICACIO_AVISTEXT 		VARCHAR2(1024 CHAR),
  NOTIFICACIO_AVISTEXTSMS 	VARCHAR2(200 CHAR),
  NOTIFICACIO_OFICITITOL 	VARCHAR2(256 CHAR),
  NOTIFICACIO_OFICITEXT 	VARCHAR2(1024 CHAR)
);
...
(
  ...
  PROCESS_INSTANCE_ID  VARCHAR2(256)            NOT NULL,
  EXPEDIENT_ID         NUMBER(19));
...
(
  ...
  CABECERA_REDUCIDA       NUMBER(1),
  LISTADO                 NUMBER(1),
  CONSULTA_ID             NUMBER(19),
  FILTRO_TAREAS_ACTIVAS   NUMBER(1),
  NUM_ELEMENTOS_PAGINA    NUMBER(3),
