...
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_ORGANCODI VARCHAR2(9 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_OFICINACODI VARCHAR2(4 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_UNITATADMIN VARCHAR2(9 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_CODPROC VARCHAR2(30 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_AVISTITOL VARCHAR2(256 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_AVISTEXT VARCHAR2(1024 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_AVISTEXTSMS VARCHAR2(200 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_OFICITITOL VARCHAR2(256 CHAR);
ALTER TABLE HEL_EXPEDIENT_TIPUS ADD NOTIFICACIO_OFICITEXT VARCHAR2(1024 CHAR);
