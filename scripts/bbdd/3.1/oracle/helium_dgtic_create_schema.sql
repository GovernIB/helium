...
CREATE PUBLIC SYNONYM HEL_ACL_CLASS_SEQ FOR HEL_ACL_CLASS_SEQ;
CREATE PUBLIC SYNONYM HEL_ACL_ENTRY_SEQ FOR  HEL_ACL_ENTRY_SEQ;
CREATE PUBLIC SYNONYM HEL_ACL_OBJECT_IDENTITY_SEQ FOR  HEL_ACL_OBJECT_IDENTITY_SEQ;
CREATE PUBLIC SYNONYM HEL_ACL_SID_SEQ FOR  HEL_ACL_SID_SEQ;
...
alter table HEL_PORTASIGNATURES move lob (ERROR_CB_PROCES) store as HEL_PORTASIG_ERRORCB_LOB (tablespace HELIUM_LOB);
