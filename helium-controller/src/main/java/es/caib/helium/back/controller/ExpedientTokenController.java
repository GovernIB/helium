...
import es.caib.helium.back.command.TokenExpedientCommand;
...
public class ExpedientTokenController extends BaseExpedientController {
	...
	private static final Logger logger = LoggerFactory.getLogger(ExpedientTokenController.class);
