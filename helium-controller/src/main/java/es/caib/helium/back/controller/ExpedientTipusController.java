...
public class ExpedientTipusController extends BaseExpedientTipusController {
	...
	public String nouPost(
			HttpServletRequest request,
			@Validated(ExpedientTipusCommand.Creacio.class) ExpedientTipusCommand command,
	...
	public String modificarPost(
			HttpServletRequest request,
			@PathVariable Long id,
			@Validated(ExpedientTipusCommand.Modificacio.class) ExpedientTipusCommand command,
			BindingResult bindingResult,
			Model model) {
        if (bindingResult.hasErrors()) {
    		omplirModelExpedientTipusForm( request, id, model);		
	...
	public String exportarPost(
			...
			@Validated(ExpedientTipusExportarCommand.Exportacio.class) ExpedientTipusExportarCommand command,
			BindingResult bindingResult,
			Model model) {
		EntornDto entornActual = SessionHelper.getSessionManager(request).getEntornActual();
		ExpedientTipusDto dto = expedientTipusService.findAmbIdPermisDissenyar(
	...
	public String importarUploadPost(
			HttpServletRequest request,
			@Validated(ExpedientTipusExportarCommand.Upload.class)
			@ModelAttribute("command")
	...
	public String importarPost(
			HttpServletRequest request,
			@Validated(ExpedientTipusExportarCommand.Importacio.class)
			@ModelAttribute("command")
			ExpedientTipusExportarCommand command,
			BindingResult bindingResult,
