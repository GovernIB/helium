...
public class ExpedientRegistreController extends BaseExpedientController {
	...
	private static final Logger logger = LoggerFactory.getLogger(ExpedientRegistreController.class);
