...
import es.caib.helium.back.validator.ExpedientTipusExportar;
import es.caib.helium.back.validator.ExpedientTipusImportar;
import es.caib.helium.back.validator.ExpedientTipusUpload;
 ...
 */
@ExpedientTipusExportar(groups = {ExpedientTipusExportarCommand.Exportacio.class})
@ExpedientTipusUpload(groups = {ExpedientTipusExportarCommand.Upload.class})
@ExpedientTipusImportar(groups = {ExpedientTipusExportarCommand.Importacio.class})
