...
import es.caib.helium.back.command.AnotacioFiltreCommand;
import es.caib.helium.back.command.AnotacioRebutjarCommand;
...
public class AnotacioController extends BaseExpedientController {
	...
	public String acceptar(
		...
		anotacioAcceptarCommand.setEntornId(entornService.getEntornActualId());
		...
		if (expedientId != null)
			...
			anotacioAcceptarCommand.setNumero(expedientService.getNumeroExpedientActual(entornService.getEntornActualId(), expedientTipusId, anotacioAcceptarCommand.getAny()));
		}
	...
	public String acceptarPost(
			...
			@PathVariable Long anotacioId,
			@Validated(AnotacioAcceptarCommand.CrearIncorporar.class) AnotacioAcceptarCommand command,
			BindingResult bindingResult,
			Model model) {
