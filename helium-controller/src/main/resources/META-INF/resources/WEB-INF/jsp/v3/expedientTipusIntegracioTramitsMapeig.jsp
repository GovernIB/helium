...
<body>			
	...
	<form:form id="mapeig-form" cssClass="form-horizontal" action="#" enctype="multipart/form-data" method="post" modelAttribute="expedientTipusIntegracioTramitsMapeigCommand" 
