...
<c:choose>
	<c:when test="${empty entornAreaCommand.id}"><
		<c:set var="titol"><spring:message code="area.form.titol.nou"/></c:set>
...
<body>
	<form:form cssClass="form-horizontal" action="${formAction}" enctype="multipart/form-data" method="post" modelAttribute="entornAreaCommand">
		<form:hidden id="id" path="id"/>
		<div class="row">
			<div class="col-sm-11">
				<hel:inputText required="true" name="codi" textKey="area.form.camp.codi" disabled="${not empty entornAreaCommand.id}"/>
				<hel:inputText required="true" name="nom" textKey="area.form.camp.nom" />
