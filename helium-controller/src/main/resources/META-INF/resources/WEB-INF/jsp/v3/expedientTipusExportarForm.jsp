...
<body>
	<form:form id="exportar-form" cssClass="form-horizontal" action="exportar" enctype="multipart/form-data" method="post" modelAttribute="command" style="min-height: 500px;">
