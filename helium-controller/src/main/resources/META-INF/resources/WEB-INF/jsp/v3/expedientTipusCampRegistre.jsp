...
<body>			
	...
	<form:form id="campRegistre-form" cssClass="form-horizontal" action="#" enctype="multipart/form-data" method="post" modelAttribute="expedientTipusCampRegistreCommand" 
