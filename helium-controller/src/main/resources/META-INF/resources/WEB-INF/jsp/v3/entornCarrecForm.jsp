...
<c:choose>
	<c:when test="${empty entornCarrecCommand.id}"><
...
<body>
	<form:form cssClass="form-horizontal" action="${formAction}" enctype="multipart/form-data" method="post" modelAttribute="entornCarrecCommand">
		<form:hidden id="id" path="id"/>
		<div class="row">
			<div class="col-sm-11">
				<hel:inputText required="true" name="codi" textKey="carrec.form.camp.codi" disabled="${not empty entornCarrecCommand.id}"/>
