 ...
 */
@Controller
public class ConsultaParamController extends BaseController {

	private DissenyService dissenyService;
	private Validator annotationValidator;

	@Autowired
	public ConsultaParamController(
	...
	@RequestMapping(value = "consulta/params", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/consulta/params", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/consulta/paramDelete", method = RequestMethod.GET)
	...
	private static final Log logger = LogFactory.getLog(ConsultaParamController.class);
