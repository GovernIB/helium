...
//		Map<Token, List<ProcessLog>> logsPerToken = jbpmHelper.getProcessInstanceLogs(processInstanceId);
...
//		WProcessInstance pi = jbpmHelper.getRootProcessInstance(processInstanceId);
