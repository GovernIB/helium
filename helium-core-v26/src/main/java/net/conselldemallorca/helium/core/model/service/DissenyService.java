...
public class DissenyService {
	...
	public DefinicioProcesExportacio exportar(Long definicioProcesId) {
		...
		for (Tasca tasca: tasques) {
			...
			dto.setFinalitzacioSegonPla(tasca.isFinalitzacioSegonPla());
	...
	public void importarExpedientTipus(
		...
		expedientTipus.setNotificacionsActivades(exportacio.isNotificacionsActivades());
		expedientTipus.setNotificacioOrganCodi(exportacio.getNotificacioOrganCodi());
		expedientTipus.setNotificacioOficinaCodi(exportacio.getNotificacioOficinaCodi());
		expedientTipus.setNotificacioUnitatAdministrativa(exportacio.getNotificacioUnitatAdministrativa());
		expedientTipus.setNotificacioCodiProcediment(exportacio.getNotificacioCodiProcediment());
		expedientTipus.setNotificacioAvisTitol(exportacio.getNotificacioAvisTitol());
		expedientTipus.setNotificacioAvisText(exportacio.getNotificacioAvisText());
		expedientTipus.setNotificacioAvisTextSms(exportacio.getNotificacioAvisTextSms());
		expedientTipus.setNotificacioOficiTitol(exportacio.getNotificacioOficiTitol());
		expedientTipus.setNotificacioOficiText(exportacio.getNotificacioOficiText());
		...
		for (Tasca nova: desti.getTasques()) {
			for (Tasca vella: origen.getTasques()) {
				if (nova.getJbpmName().equals(vella.getJbpmName())) {
					...
					nova.setFinalitzacioSegonPla(vella.isFinalitzacioSegonPla());
