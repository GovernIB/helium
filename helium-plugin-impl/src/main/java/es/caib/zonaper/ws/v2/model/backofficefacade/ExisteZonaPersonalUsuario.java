...
@XmlRootElement(name = "existeZonaPersonalUsuario")
public class ExisteZonaPersonalUsuario {

    @XmlElement(required = true)
    protected String nifUsuario;

    /**
     * Gets the value of the nifUsuario property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the nifUsuario property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
