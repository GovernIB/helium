...
public class ListServerSignersResponse  implements java.io.Serializable {
    ...
    private ServerSigner[] serverSigners;
     ...
     */
    public ServerSigner[] getServerSigners() {
        return serverSigners;
    }
     ...
     * @param serverSigners
     */
    public void setServerSigners(ServerSigner[] serverSigners) {
        this.serverSigners = serverSigners;
    }
