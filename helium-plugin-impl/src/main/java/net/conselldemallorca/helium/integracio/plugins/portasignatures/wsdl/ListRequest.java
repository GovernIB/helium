...
public class ListRequest  implements java.io.Serializable {
    ...
    private ListRequestDocument[] documents;
     ...
     * @return documents
     */
    public ListRequestDocument[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(ListRequestDocument[] documents) {
        this.documents = documents;
    }
