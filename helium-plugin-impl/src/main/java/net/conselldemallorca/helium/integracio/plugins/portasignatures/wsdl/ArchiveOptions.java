...
public class ArchiveOptions  implements java.io.Serializable {
    ...
    private ArchiveLocator[] destinationLocators;

    private ArchiveMetadata[] archiveMetadatas;

    public ArchiveOptions() {
    }

    public ArchiveOptions(
           ArchiveLocator[] sourceLocators,
           ArchiveLocator[] destinationLocators,
           ArchiveMetadata[] archiveMetadatas) {
     ...
     */
    public ArchiveLocator[] getSourceLocators() {
        return sourceLocators;
    }
     ...
     */
    public void setSourceLocators(ArchiveLocator[] sourceLocators) {
        this.sourceLocators = sourceLocators;
    }
     ...
     */
    public ArchiveLocator[] getDestinationLocators() {
        return destinationLocators;
    }
     ...
     */
    public void setDestinationLocators(ArchiveLocator[] destinationLocators) {
        this.destinationLocators = destinationLocators;
    }
     ...
     */
    public void setArchiveMetadatas(ArchiveMetadata[] archiveMetadatas) {
        this.archiveMetadatas = archiveMetadatas;
    }
