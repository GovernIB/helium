...
public class CwsServiceLocator extends org.apache.axis.client.Service implements CwsService {
    ...
    private java.lang.String CWS_address = "http://sdesapplin3.caib.es:38080/portafirmasws/web/services/CWS";
    ...
    public Cws getCWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CWSSoapBindingStub _stub = new CWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Cws.class.isAssignableFrom(serviceEndpointInterface)) {
                CWSSoapBindingStub _stub = new CWSSoapBindingStub(new java.net.URL(CWS_address), this);
                _stub.setPortName(getCWSWSDDServiceName());
                return _stub;
            }
        }
