...
public class ListResponse  implements java.io.Serializable {
    ...
    private ListResponseDocument[] documents;
    ...
    public ListResponse(
           Result result,
           ListResponseDocument[] documents,
     ...
     * @return documents
     */
    public ListResponseDocument[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(ListResponseDocument[] documents) {
        this.documents = documents;
    }
