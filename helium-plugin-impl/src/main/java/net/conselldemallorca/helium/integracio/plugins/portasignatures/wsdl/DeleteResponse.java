...
public class DeleteResponse  implements java.io.Serializable {
    ...
    private DeleteResponseDocument[] documents;
    ...
    public DeleteResponse(
           Result result,
           DeleteResponseDocument[] documents,
     ...
     * @return documents
     */
    public DeleteResponseDocument[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(DeleteResponseDocument[] documents) {
        this.documents = documents;
    }
