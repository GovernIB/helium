...
@XmlType(name = "ConfiguracionAvisosExpediente", namespace = "urn:es:caib:zonaper:ws:v1:model:ConfiguracionAvisosExpediente", propOrder = {
    "habilitarAvisos",
    "avisoSMS",
    "avisoEmail"
})
public class ConfiguracionAvisosExpediente {
    ...
    public void setHabilitarAvisos(JAXBElement<Boolean> value) {
        this.habilitarAvisos = ((JAXBElement<Boolean> ) value);
    }
