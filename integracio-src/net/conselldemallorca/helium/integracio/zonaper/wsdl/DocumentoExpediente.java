...
@XmlType(name = "DocumentoExpediente", namespace = "urn:es:caib:zonaper:ws:v1:model:DocumentoExpediente", propOrder = {
    "titulo",
    "nombre",
    "contenidoFichero",
    "modeloRDS",
...
public class DocumentoExpediente {
    ...
    public void setModeloRDS(JAXBElement<String> value) {
        this.modeloRDS = ((JAXBElement<String> ) value);
    }
    ...
    public void setVersionRDS(JAXBElement<Integer> value) {
        this.versionRDS = ((JAXBElement<Integer> ) value);
    }
