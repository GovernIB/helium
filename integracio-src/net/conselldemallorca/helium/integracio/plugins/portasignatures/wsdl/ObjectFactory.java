 ...
 * generated in the net.conselldemallorca.helium.integracio.plugins.portasignatures.wsdl package. 
...
public class ObjectFactory {
    ...
    private final static QName _DownloadStepMinimalSigners_QNAME = new QName("", "minimal-signers");
    ...
    private final static QName _UploadRequestDocumentArchiveOptions_QNAME = new QName("", "archive-options");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.conselldemallorca.helium.integracio.plugins.portasignatures.wsdl
     * 
     */
    ...
    public JAXBElement<Integer> createDownloadStepMinimalSigners(Integer value) {
        return new JAXBElement<Integer>(_DownloadStepMinimalSigners_QNAME, Integer.class, DownloadStep.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createUploadRequestDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_UploadRequestDocumentArchiveOptions_QNAME, ArchiveOptions.class, UploadRequestDocument.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createDownloadResponseDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_UploadRequestDocumentArchiveOptions_QNAME, ArchiveOptions.class, DownloadResponseDocument.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createListResponseDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_UploadRequestDocumentArchiveOptions_QNAME, ArchiveOptions.class, ListResponseDocument.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createSignatureFileArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_UploadRequestDocumentArchiveOptions_QNAME, ArchiveOptions.class, SignatureFile.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createVisualFileArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_UploadRequestDocumentArchiveOptions_QNAME, ArchiveOptions.class, VisualFile.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createUpdateRequestDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_UploadRequestDocumentArchiveOptions_QNAME, ArchiveOptions.class, UpdateRequestDocument.class, value);
    }
    ...
    public JAXBElement<Integer> createUploadStepMinimalSigners(Integer value) {
        return new JAXBElement<Integer>(_DownloadStepMinimalSigners_QNAME, Integer.class, UploadStep.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createAnnexArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_UploadRequestDocumentArchiveOptions_QNAME, ArchiveOptions.class, Annex.class, value);
    }
    ...
    public JAXBElement<Integer> createListStepMinimalSigners(Integer value) {
        return new JAXBElement<Integer>(_DownloadStepMinimalSigners_QNAME, Integer.class, ListStep.class, value);
    }
