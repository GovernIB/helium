...
<body>
	<c:choose>
		<c:when test="${not tancarRegistre}">
			<form:form action="varRegistreMassiva.html" cssClass="uniForm tascaForm zebraForm">
				<form:hidden path="id"/>
				<form:hidden path="registreId"/>
				<form:hidden path="entornId"/>
				<form:hidden path="index"/>
				<input type="hidden" id="campCodi" name="campCodi" value="${param.campCodi}"/>
				...
				<c:import url="../common/formElement.jsp">
					...
					<c:param name="titles"><fmt:message key='comuns.guardar' />,<fmt:message key='comuns.cancelar' /></c:param>
				</c:import>
			</form:form>
