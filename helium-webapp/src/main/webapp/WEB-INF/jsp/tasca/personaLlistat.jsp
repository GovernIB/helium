...
<body>
	...
	<display:table name="personaLlistat" id="registre" requestURI="" class="displaytag selectable" sort="external" defaultsort="4" defaultorder="descending" >
		...
		<display:column property="dataCreacio" titleKey="tasca.pllistat.creada_el" format="{0,date,dd/MM/yyyy HH:mm}" sortable="true" sortName="dataCreacio"/>
		<display:column titleKey="tasca.pllistat.prioritat" sortable="true" sortName="prioritat">
			<c:choose>
		...
		<display:column property="dataLimit" titleKey="tasca.pllistat.data_limit" format="{0,date,dd/MM/yyyy HH:mm}" sortable="true" sortName="dataLimit" style="${estilData}"/>
		<display:column>
