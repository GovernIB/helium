			...
			<div class="btn-group">
				...
				<ul id="dropdown-menu-${tasca.id}" class="dropdown-menu">
					<c:if test="${tasca.open and not tasca.suspended and tasca.assignee == dadesPersona.codi and tasca.assignadaUsuariActual}">
						<li><a id="tramitar-tasca-${tasca.id}" href="../../v3/tasca/${tasca.id}" class="icon" data-rdt-link-callback="recarregarLlistatTasques(${procesId},${tasca.id});" data-rdt-link-modal="true" data-rdt-link-modal-maximize="true"><span class="fa fa-folder-open"></span> ii<spring:message code="tasca.llistat.accio.tramitar"/></a></li>
