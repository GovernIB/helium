...
<html>
<head>
	<title><spring:message code="procediment.actualitzacio.servei.titol"/></title>
	...
	<script>
		...
		var intervalProgres;
		var writtenBlocs = 0;
		var title="<spring:message code="procediment.actualitzacio.servei.titol"/>";
		var content="<spring:message code="procediment.actualitzacio.servei.cancelarActu"/>";
		...
		function getProgres() {
			$.ajax({
				type: 'GET',
				url: "<c:url value='/v3/procediment/servei/actualitzar/progres'/>",
				data: {
					index : writtenBlocs
				},
...
<body>
	<c:if test="${isUpdatingProcediments}">
		<div class="confirmacio">
			<h4><spring:message code="procediment.actualitzacio.servei.procesActiu"/></h4>
		</div>
	</c:if>
	<c:if test="${not isUpdatingProcediments}">
		<div class="confirmacio">
			<h4><spring:message code="procediment.actualitzacio.servei.confirmacio"/></h4>
		</div>
	</c:if>

	<c:set var="formAction"><c:url value="/v3/procediment/servei/actualitzar"/></c:set>		
