...
<body>
			...
			<tr>
				...
				<th data-col-name="numValors" data-template="#cellValorsTemplate" data-orderable="false" width="13%">
					<script id="cellValorsTemplate" type="text/x-jsrender">
							<a data-toggle="modal" data-callback="callbackModalEnumerats()" href="enumeracio/{{:id}}/valors" class="btn btn-default"><span class="fa fa-bars"></span>&nbsp;<spring:message code="expedient.tipus.enumeracio.llistat.boto.valors"/>&nbsp;<span class="badge">{{:numValors}}</span></a>
						</script>
				</th>
					...
					<script id="cellEnumTemplate" type="text/x-jsrender">
							<div class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a data-toggle="modal" data-callback="callbackModalEnumerats()" href="enumeracio/{{:id}}/update"><span class="fa fa-pencil"></span>&nbsp;<spring:message code="comu.boto.modificar"/></a></li>
	...
	function refrescaTaula() {
		$('#enumeracio').webutilDatatable('refresh-url', 'enumeracio/datatable');
	}
