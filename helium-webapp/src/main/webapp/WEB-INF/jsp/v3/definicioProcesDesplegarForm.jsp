...
<body>		
	<form:form id="desplegar-form" cssClass="form-horizontal" action="desplegar" enctype="multipart/form-data" method="post" commandName="command" style="min-height: 500px;">
		...
		<hel:inputSelect emptyOption="true" name="expedientTipusId" textKey="definicio.proces.desplegar.form.tipusExpedient" placeholderKey="definicio.proces.desplegar.form.tipusExpedient.placeholder" optionItems="${expedientsTipus}" optionValueAttribute="id" optionTextAttribute="codi"/>
