					...
					<spring:message code="expedient.tipus.enumeracio.llistat.columna.codi"/>
						<script id="cellExpedientTipusEnumeracioCodiTemplate" type="text/x-jsrender">
								{{if heretat }}
									...
									<span class="label label-primary herencia" title="<spring:message code="expedient.tipus.enumeracio.llistat.codi.heretat"/>">R</span>
								{{else}}
									{{:codi}}
									{{if sobreescriu }}
										<span class="label label-warning herencia" title="<spring:message code="expedient.tipus.enumeracio.llistat.codi.sobreescriu"/>">S</span>
									{{/if}}
								{{/if}}
						</script>
					</th>
