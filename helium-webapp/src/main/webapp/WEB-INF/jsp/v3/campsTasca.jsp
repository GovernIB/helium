...
<%-- SUGGEST ------------------------------------------------------------------------------------%>
			<c:if test="${dada.campTipus == 'SUGGEST'}">
				...
				<c:choose>
					<c:when test='${dada.campMultiple or isMultiple}'><input type="text" id="${campCodi}" name="${campNom}" class="form-control suggest" <c:if test="${disabled}">disabled </c:if>value="${command[campNom][campIndex]}" data-urlconsultainicial="${urlConsultaInicial}" data-urlconsultallistat="${urlConsultaLlistat}"/></c:when>
					<c:otherwise><form:input path="${campCodi}" cssClass="form-control suggest" id="${campCodi}" disabled="${disabled}" data-urlconsultainicial="${urlConsultaInicial}" data-urlconsultallistat="${urlConsultaLlistat}"/></c:otherwise>
				</c:choose>
			</c:if>
...
<%-- SELECCIO ------------------------------------------------------------------------------------%>					
			<c:if test="${dada.campTipus == 'SELECCIO'}">
				...
				<c:choose>
					<c:when test='${dada.campMultiple or isMultiple}'><input type="text" id="${campCodi}" name="${campNom}" class="seleccio" data-required="${dada.required}" data-campid="${dada.campId}" data-placeholder="${placeholder}" value="${command[campNom][campIndex]}"/></c:when>
					<c:otherwise><form:input path="${campCodi}" id="${campCodi}" cssClass="seleccio" data-required="${dada.required}" data-campid="${dada.campId}" data-placeholder="${placeholder}"/></c:otherwise>
				</c:choose>
			</c:if>
