...
<body>
	...
	<form:form action="documentForm.html" cssClass="uniForm" enctype="multipart/form-data">
		<div class="inlineLabels">
			...
			<c:import url="../common/formElement.jsp">
				<c:param name="property" value="convertirExtensio"/>
				<c:param name="label"><fmt:message key="defproc.docform.gen_ext"/></c:param>
			</c:import>
			<c:import url="../common/formElement.jsp">
			...
			<c:import url="../common/formElement.jsp">
				<c:param name="property" value="extensionsPermeses"/>
				<c:param name="label"><fmt:message key="defproc.docform.ext_perm"/></c:param>
				<c:param name="comment"><fmt:message key="defproc.docform.sep_comes"/></c:param>
			</c:import>
			<c:import url="../common/formElement.jsp">
