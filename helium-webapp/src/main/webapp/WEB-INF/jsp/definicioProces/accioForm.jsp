	...
	<form:form action="accioForm.html" cssClass="uniForm">
		<div class="inlineLabels">
			...
			<c:import url="../common/formElement.jsp">
				...
				<c:param name="itemBuit">&lt;&lt; <fmt:message key="defproc.accform.selec_hand"/> &gt;&gt;</c:param>
				<c:param name="label"><fmt:message key="defproc.accform.handler"/></c:param>
			</c:import>
			<c:import url="../common/formElement.jsp">
			...
			<c:import url="../common/formElement.jsp">
				<c:param name="property" value="publica"/>
				<c:param name="type" value="checkbox"/>
				<c:param name="label"><fmt:message key="defproc.accform.publica"/></c:param>
			</c:import>
			<c:import url="../common/formElement.jsp">
				<c:param name="property" value="oculta"/>
				<c:param name="type" value="checkbox"/>
