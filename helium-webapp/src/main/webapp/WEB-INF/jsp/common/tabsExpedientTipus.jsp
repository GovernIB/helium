...
<ul id="tabnav">
	...
	<c:if test="${tePermisDissenyTipusExpedient || tePermisDissenyEntorn}">
		...
		<li<c:if test="${param.tabActiu == 'sistra'}"> class="active"</c:if>><a href="<c:url value="/expedientTipus/sistra.html"><c:param name="expedientTipusId" value="${expedientTipus.id}"/></c:url>"><fmt:message key='common.tabsexptipus.integ_sistra' /></a></li>
