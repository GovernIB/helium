	...
	public String consultaDissenyInforme(
		...
		if (entorn != null) {
			...
			if (commandFiltre != null) {
				populateModelCommon(entorn, model, commandSeleccio);
				Consulta consulta = dissenyService.getConsultaById(commandSeleccio.getConsultaId());
				adminService.getMesuresTemporalsHelper().mesuraIniciar("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null);
				if (consulta.getInformeNom() != null) {
					model.addAttribute("commandFiltre", commandFiltre);
					adminService.getMesuresTemporalsHelper().mesuraIniciar("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Camps");
					List<Camp> camps = dissenyService.findCampsPerCampsConsulta(
							commandSeleccio.getConsultaId(),
							TipusConsultaCamp.FILTRE,
							true);
					adminService.getMesuresTemporalsHelper().mesuraCalcular("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Camps");
					adminService.getMesuresTemporalsHelper().mesuraIniciar("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Valors");
					Map<String, Object> valors = TascaFormUtil.getValorsFromCommand(
							camps,
							commandFiltre,
							true,
							true);
					adminService.getMesuresTemporalsHelper().mesuraCalcular("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Valors");
					adminService.getMesuresTemporalsHelper().mesuraIniciar("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Valors per service");
					Map<String, Object> valoresConsulta = getValorsPerService(camps, valors);
					adminService.getMesuresTemporalsHelper().mesuraCalcular("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Valors per service");
					adminService.getMesuresTemporalsHelper().mesuraIniciar("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Recuperar consulta disseny");
...
//						}
//					}
					adminService.getMesuresTemporalsHelper().mesuraCalcular("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Recuperar consulta disseny");
					adminService.getMesuresTemporalsHelper().mesuraIniciar("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Generar datos datasource");
					...
					adminService.getMesuresTemporalsHelper().mesuraCalcular("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null, "Generar datos datasource");
					adminService.getMesuresTemporalsHelper().mesuraCalcular("INFORME: " + consulta.getCodi(), "report", consulta.getExpedientTipus().getNom(), null);
