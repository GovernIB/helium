 ...
 *         &lt;element name="arg2" type="{http://conselldemallorca.net/helium/ws/tramitacio/v1}parellaCodiValor" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SetDadesFormulariTasca {
    ...
    protected List<ParellaCodiValor> arg2;
     ...
     * 
     */
    public List<ParellaCodiValor> getArg2() {
        if (arg2 == null) {
            arg2 = new ArrayList<ParellaCodiValor>();
        }
        return this.arg2;
    }
