...
public class ParametreServiceImpl implements ParametreService {
	...
	public ParametreDto update(
		...
		Parametre parametreEntity = parametreRepository.findById(parametre.getId()).orElse(null);
	...
	public ParametreDto delete(
		...
		Parametre parametreEntity = parametreRepository.findById(id).orElse(null);
