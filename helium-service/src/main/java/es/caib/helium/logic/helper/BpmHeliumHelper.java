...
@Slf4j
@Component
public class BpmHeliumHelper implements BpmnHeliumService {
	...
	@Autowired
	private ExpedientDocumentHelper documentHelper;
	@Autowired
	...
	public EntornDto getEntornActual() {
		...
		log.debug("Obtenint entorn actual (idEntornActual=" + entornId + ")");
		if (entornId == null)
			return null;
		return conversioTipusHelper.convertir(
			entornRepository.getReferenceById(entornId),
			EntornDto.class);
	}

	@Override
	public ExpedientDto getExpedientIniciant() {
		log.debug("Obtenint expedient en fase d'inici");
		return conversioTipusHelper.convertir(
	...
	public ExpedientDto getExpedientAmbEntornITipusINumero(
		...
		String numero) {
		log.debug("Obtenint expedient donat entorn, tipus i número (" +
			"entornId=" + entornId + ", " +
	...
	public ExpedientDto getExpedientArrelAmbProcessInstanceId(
		...
		log.debug("Obtenint expedient donada una instància de procés (processInstanceId=" + processInstanceId + ")");
		return conversioTipusHelper.convertir(
	...
	public DefinicioProcesDto getDefinicioProcesAmbJbpmKeyIProcessInstanceId(
		String jbpmKey,
		String processInstanceId) {
		log.debug("Obtenint la darrera versió de la definició de procés donat el codi jBPM i el processInstanceId (jbpmKey=" + jbpmKey + ", processInstanceId=" + processInstanceId +")");
	...
	public DefinicioProcesDto getDefinicioProcesAmbJbpmKeyIVersio(
		String jbpmKey,
		int version) {
		log.debug("Obtenint la definició de procés donat el codi jBPM i la versió (jbpmKey=" + jbpmKey + ", version=" + version +")");
		return conversioTipusHelper.convertir(
	...
	public DefinicioProcesDto getDarreraVersioAmbEntornIJbpmKey(
		...
		String jbpmKey) {
		log.debug("Obtenint la darrera versió de la definició de procés donat l'entorn, tipus i el codi jBPM (entornId=" + entornId + ", expedientTipusId=" + expedientTipusId + ", jbpmKey=" + jbpmKey + ")");
		return conversioTipusHelper.convertir(
	...
	public DefinicioProcesDto getDefinicioProcesPerProcessInstanceId(
		String processInstanceId) {
		log.debug("Obtenint la definició de procés donada la instància de procés (processInstanceId=" + processInstanceId + ")");
		return conversioTipusHelper.convertir(
	...
	public PersonaDto getPersonaAmbCodi(String codi) {
		log.debug("Obtenint persona (codi=" + codi + ")");
		return conversioTipusHelper.convertir(
	...
	public AreaDto getAreaAmbEntornICodi(
		Long entornId,
		String codi) {
		log.debug("Obtenint area donat l'entorn i el codi (" +
			"entornId=" + entornId + ", " +
			"codi=" + codi + ")");
		Entorn entorn = entornRepository.findById(entornId).orElse(null);
		if (entorn == null)
	...
	public CarrecDto getCarrecAmbEntornIAreaICodi(
		...
		String areaCodi,
		String carrecCodi) {
		log.debug("Obtenint carrec donat l'entorn, l'àrea i el codi (" +
			"entornId=" + entornId + ", " +
			"areaCodi=" + areaCodi + ", " +
	...
	public List<FestiuDto> findFestiusAll() {
		log.debug("Obtenint la llista de tots els festius");
	...
	public ReassignacioDto findReassignacioActivaPerUsuariOrigen(
		String processInstanceId,
		String usuariCodi) {
		log.debug("Obtenint reassignació activa per a l'usuari ("
	...
	public void interessatCrear(
		...
		Expedient expedient = expedientRepository.getReferenceById(interessat.getExpedientId());
	...
	public void expedientModificarEstat(
		String processInstanceId,
		String estatCodi) {
		log.debug("Modificant estat de l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"estatCodi=" + estatCodi + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
	...
	public void expedientModificarComentari(
		String processInstanceId,
		String comentari) {
		log.debug("Modificant comentari de l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"comentari=" + comentari + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
		expedientHelper.update(
	...
	public void expedientModificarGeoref(
		...
		Double posy,
		String referencia) {
		log.debug("Modificant georeferència de l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"posx=" + posx + ", " +
			"posy=" + posy + ", " +
	...
	public void expedientModificarGrup(
		String processInstanceId,
		String grupCodi) {
		log.debug("Modificant grup de l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"grupCodi=" + grupCodi + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
		expedientHelper.update(
	...
	public void expedientModificarNumero(
		String processInstanceId,
		String numero) {
		log.debug("Modificant número de l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"numero=" + numero + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
		expedientHelper.update(
	...
	public void expedientModificarResponsable(
		...
		log.debug("Modificant responsable de l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
	...
	public void expedientModificarTitol(
		String processInstanceId,
		String titol) {
		log.debug("Modificant títol de l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"titol=" + titol + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
		expedientHelper.update(
	...
	public void expedientAturar(
		String processInstanceId,
		String motiu) {
		log.debug("Aturant expedient (processInstanceId=" + processInstanceId + ", motiu=" + motiu + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
	...
	public void expedientReprendre(
		String processInstanceId) {
		log.debug("Reprenent expedient (processInstanceId=" + processInstanceId + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
	...
	public ArxiuDto documentGenerarAmbPlantilla(
		...
		String documentCodi,
		Date dataDocument) {
		log.debug("Generant document amb plantilla (" +
			"taskInstanceId=" + taskInstanceId + ", " +
			"processInstanceId=" + processInstanceId + ", " +
	...
	public void documentFirmaServidor(
		...
		if(documentStoreId==null) {
			DocumentStore ds = documentHelper.findDocumentStore(
				null,
				processInstanceId,
				null,
				documentCodi);
	...
	public TerminiDto getTerminiAmbProcessInstanceICodi(
		String processInstanceId,
		String terminiCodi) {
		log.debug("Obtenint termini donada la instància de procés i el codi (" +
			"processInstanceId=" + processInstanceId + "," +
	...
	public TerminiIniciatDto getTerminiIniciatAmbProcessInstanceITerminiCodi(
		String processInstanceId,
		String terminiCodi) {
		log.debug("Obtenint termini iniciat donada la instància de procés i el codi (" +
			"processInstanceId=" + processInstanceId + ", " +
			"terminiCodi=" + terminiCodi + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
	...
	public void configurarTerminiIniciatAmbDadesJbpm(
		...
		String taskInstanceId,
		Long timerId) {
		log.debug("Configurant termini iniciat (" +
		...
		if (timerId != null)
			terminiIniciat.afegirTimerId(timerId);
	}
	...
	public Date terminiCalcularDataInici(
		...
		boolean laborable,
		String processInstanceId) {
		log.debug("Calculant data d'inici de termini a partir d'una data de fi (" +
			"fi=" + fi + ", " +
			"anys=" + anys + ", " +
			"mesos=" + mesos + ", " +
			"dies=" + dies + ", " +
	...
	public Date terminiCalcularDataFi(
		...
		boolean laborable,
		String processInstanceId) {
		log.debug("Calculant data de fi de termini a partir d'una data d'inici (" +
			"inici=" + inici + ", " +
			"anys=" + anys + ", " +
			"mesos=" + mesos + ", " +
			"dies=" + dies + ", " +
	...
	public void terminiCancelar(
		Long terminiIniciatId,
		Date data) {
		log.debug("Cancelant termini iniciat (" +
			"terminiIniciatId=" + terminiIniciatId + ", " +
			"data=" + data + ")");
	...
	public void terminiPausar(
		Long terminiIniciatId,
		Date data) {
		log.debug("Pausant termini iniciat (" +
			"terminiIniciatId=" + terminiIniciatId + ", " +
			"data=" + data + ")");
		TerminiIniciat termini = terminiHelper.findTerminiIniciatById(terminiIniciatId);
		if (termini == null)
	...
	public void terminiContinuar(
		Long terminiIniciatId,
		Date data) {
		log.debug("Continuant termini iniciat (" +
			"terminiIniciatId=" + terminiIniciatId + ", " +
			"data=" + data + ")");
		TerminiIniciat termini = terminiHelper.findTerminiIniciatById(terminiIniciatId);
		if (termini == null)
	...
	public List<DominiRespostaFilaDto> dominiConsultar(
		...
		log.debug("Executant una consulta de domini (" +
			"processInstanceId=" + processInstanceId + ", " +
	...
	public List<EnumeracioValorDto> enumeracioConsultar(
		...
		log.debug("Consultant els valors d'una enumeració (" +
			"processInstanceId=" + processInstanceId + ", " +
	...
	public void enumeracioSetValor(
		...
		log.debug("Fixant el valor d'una enumeració (" +
			"processInstanceId=" + processInstanceId + ", " +
			"enumeracioCodi=" + enumeracioCodi + ", " +
			"codi=" + codi + ", " +
			"valor=" + valor + ")");
	...
	public List<CampTascaDto> findCampsPerTaskInstance(
		String taskInstanceId) {
		log.debug("Consultant els camps del formulari de la tasca (" +
			"taskInstanceId=" + taskInstanceId + ")");
	...
	public List<DocumentTascaDto> findDocumentsPerTaskInstance(
		String taskInstanceId) {
		log.debug("Consultant els documents de la tasca (taskInstanceId=" + taskInstanceId + ")");
		WTaskInstance task = workflowEngineApi.getTaskById(taskInstanceId);
		if (task == null)
			throw new NoTrobatException(WTaskInstance.class, taskInstanceId);
		DefinicioProces definicioProces = definicioProcesRepository.findByJbpmId(
	...
	public DocumentDto getDocumentInfo(Long documentStoreId) {
		log.debug("Obtenint informació del document (" +
	...
	public ArxiuDto getArxiuPerMostrar(Long documentStoreId) {
		log.debug("Obtenint arxiu del document (" +
			"documentStoreId=" + documentStoreId + ")");
...
//			null);
	...
	public Long documentExpedientGuardar(
		...
		String arxiuNom,
		byte[] arxiuContingut) {
		log.debug("Guardant un document a dins l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"documentCodi=" + documentCodi + ", " +
			"data=" + data + ", " +
			"arxiuNom=" + arxiuNom + ", " +
			"arxiuContingut=" + Arrays.toString(arxiuContingut) + ")");
	...
	public Long documentExpedientGuardar(
		...
		return documentHelper.setDocument(
			null,
			processInstanceId,
			null,
			documentCodi,
	...
	public void desfinalitzarExpedient(String processInstanceId) throws Exception{
		log.debug("Desfinalitzant expedient(processInstanceId=" + processInstanceId + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
	...
	public void finalitzarExpedient(String processInstanceId) throws Exception {
		log.debug("Finalitzant expedient (processInstanceId=" + processInstanceId + ")");
		Expedient expedient = expedientHelper.findExpedientByProcessInstanceId(processInstanceId);
	...
	public Long documentExpedientAdjuntar(
		...
		String arxiuNom,
		byte[] arxiuContingut) {
		log.debug("Guardant un document adjunt a dins l'expedient (" +
			"processInstanceId=" + processInstanceId + ", " +
			"adjuntId=" + adjuntId + ", " +
	...
	public void documentExpedientEsborrar(
		...
		String processInstanceId,
		String documentCodi) {
		log.debug("Esborrant un document de dins l'expedient (" +
			"taskInstanceId=" + taskInstanceId + ", " +
			"processInstanceId=" + processInstanceId + ", " +
			"documentCodi=" + documentCodi + ")");
...
//			registreEntrada);
	...
	public boolean isRegistreActiu() {
		log.debug("Comprovant si el plugin de registre està actiu");
	...
	public ScspRespostaPinbal consultaPinbal(
		...
		Entorn entorn = entornRepository.findById(expedient.getEntorn().getId()).orElse(null);
		if (entorn == null)
		...
		if (dadesConsultaPinbal.getDocumentCodi()==null) {
			...
			DocumentStore document = documentHelper.findDocumentStore(
				expedient.getId(),
				processInstanceId,
				null,
		...
		if(dadesConsultaPinbal.isAsincrona()) {
			...
			if(scspConfirmacioPeticioPinbal!=null && scspConfirmacioPeticioPinbal.getAtributos()!=null) {
				...
				documentStoreJusificantId = documentHelper.setDocument(
					null,
					processInstanceId,
					null,
					dadesConsultaPinbal.getDocumentCodi(),
		...
		guardaPeticioPinbalSenseError(
			expedient,
			documentStoreRepository.getReferenceById(documentStoreJusificantId),
			dadesConsultaPinbal,
...
//			scspConfirmacioPeticioPinbal.setAtributos(new ScspAtributosPinbal());
...
//			scspConfirmacioPeticioPinbal.getAtributos().setIdPeticion("PROVA_ASYNC");
	...
	private DadesConsultaPinbal convertirDadesDeDto(DadesConsultaPinbalDto dadesDto, ExpedientTipus expedientTipus, Expedient expedient) {
		...
		{
			log.error("Error d'integraicó consultant la UO: " +
				codiUO!=null ? codiUO : expedientTipus.getNtiOrgano()
				+  " " + e.getMessage(), e);
			log.warn("Com a unitat tramitadora per la consulta a PINBAL es fixa el codi DIR3 " + expedientTipus.getNtiOrgano());
	...
	public RegistreIdDto notificacioCrear(
		...
		log.info("###===> INICIANT MÈTODES PER A REGISTRAR NOTIFICACIÓ.");
		...
		log.info("###===> Resposta registre notificacio plugin: ");
		log.info("###========> Numero: " + respostaPlugin.getNumero());
		log.info("###========> Data: " + respostaPlugin.getData());

		if (respostaPlugin.getReferenciaRDSJustificante() != null) {
			log.info("###========> Just.Codi: " + respostaPlugin.getReferenciaRDSJustificante().getCodigo());
			log.info("###========> Just.Clau: " + respostaPlugin.getReferenciaRDSJustificante().getClave());
		}
	...
	public void notificacioGuardar(
		...
		log.debug("Guardant una notificació de l'expedient (" +
		...
		throw new RuntimeException("Method (notificacioGuardar) not implemented");
//		notificacioElectronicaHelper.altaNotificacio(
//			expedient,
//			notificacio);
	}
	...
	public boolean notificacioEsborrar(
		...
		String clave,
		Long codigo) {
		log.debug("Esborrar una notificació de l'expedient (" +
			"numero=" + numero + ", " +
			"RDSClave=" + clave + ", " +
			"RDSCodigo=" + codigo + ")");
		throw new RuntimeException("Method (notificacioEsborrar) not implemented");
...
//			codigo);
	...
	public RespostaNotificacio altaNotificacio(DadesNotificacioDto dadesNotificacio) {
		...
		resposta.setEstat(RespostaNotificacio.NotificacioEstat.valueOf(notificacio.getEstat().name()));
	...
	public Integer portasignaturesEnviar(
		...
		DocumentStore documentStore = documentStoreRepository.getReferenceById(documentId);
		...
		return pluginHelper.portasignaturesEnviar(
			...
			annexos,
			blocList,
			expedientRepository.getReferenceById(expedientId),
			importancia,
			dataLimit,
			tokenId,
			processInstanceId,
	...
	public void zonaperExpedientCrear(
		...
		Expedient ex = expedientRepository.getReferenceById(expedient.getId());
	...
	public TramitDto getTramit(String numero, String clau) {
		log.debug("Obtenint dades del tràmit (numero=" + numero + ", clau=" + clau + ")");
		return conversioTipusHelper.convertir(
	...
	public ArxiuDto getArxiuGestorDocumental(String id) {
		log.debug("Obtenint arxiu de la gestió documental (id=" + id + ")");
	...
	public EstatDto findEstatAmbEntornIExpedientTipusICodi(
		...
		String expedientTipusCodi,
		String estatCodi) {
		log.debug("Obtenint l'estat donat l'entorn, el tipus d'expedient i el codi (" +
			"entornId=" + entornId + ", " +
			"expedientTipusCodi=" + expedientTipusCodi + ", " +
			"estatCodi=" + estatCodi + ")");
		Entorn entorn = entornRepository.findById(entornId).orElse(null);
	...
	public DocumentDissenyDto getDocumentDisseny(
		...
		String processInstanceId,
		String documentCodi) {
		log.debug("Obtenint el document de disseny donada la definició de procés i el codi (" +
	...
	public void expedientRelacionar(
		...
		log.debug("Relacionant els expedients (" +
			"expedientIdOrigen=" + expedientIdOrigen + ", " +
			"expedientIdDesti=" + expedientIdDesti + ")");
		Expedient origen = expedientRepository.findById(expedientIdOrigen).orElse(null);
		if (origen == null)
			throw new NoTrobatException(Expedient.class, expedientIdOrigen);
		Expedient desti = expedientRepository.findById(expedientIdDesti).orElse(null);
		if (desti == null)
	...
	public ExpedientDadaDto getDadaPerProcessInstance(
		String processInstanceId,
		String varCodi) {
		log.debug("Obtenint la dada de l'instància de procés (processInstanceId=" + processInstanceId + ")");
	...
	public TascaDadaDto getDadaPerTaskInstance(
		...
		String taskInstanceId,
		String varCodi) {
		log.debug("Obtenint la dada de l'instància de tasca (taskInstanceId=" + taskInstanceId + ")");
		DefinicioProces definicioProces = getDefinicioProcesDonatProcessInstanceId(
			processInstanceId);
		if (definicioProces == null)
	...
	public ExpedientDto findExpedientAmbMateixTipusINumero(
		...
		Long expedientTipusId,
		String numero) {
		log.debug("findExpedientsAmbMateixTipusINumero (" +
			"entornId=" + entornId + ", " +
			"numero=" + numero + ", " +
	...
	public List<ExpedientDto> findExpedientsConsultaGeneral(
		...
		log.debug("Consultant expedients (" +
			"entornId=" + entornId + ", " +
			"titol=" + titol + ", " +
			"numero=" + numero + ", " +
		...
		if (expedientTipusId != null) {
			...
			if (expedientTipus == null)
				throw new NoTrobatException(ExpedientTipus.class, expedientTipusId);
			if (estatId != null) {
				estat = estatRepository.findById(estatId).orElse(null);
				if (estat == null)
	...
	public List<ExpedientDto> findExpedientsConsultaDadesIndexades(
		...
		log.debug("Consultant expedients a Lucene (" +
			"entornId=" + entornId + ", " +
			"expedientTipusCodi=" + expedientTipusCodi + ", " +
...
//	@Transactional(propagation = Propagation.REQUIRES_NEW)
	public void updateExpedientError(
		...
		String errorDesc,
		String errorFull) {
		log.error("JOB (" + jobId + "): Actualitzant error de l'expedient");
//		if (jobId != null)
//			workflowEngineApi.retryJob(jobId);
	...
	public List<DefinicioProcesDto> findSubDefinicionsProces(Long definicioProcesId) {
		...
		DefinicioProces definicioProces = definicioProcesRepository.getReferenceById(definicioProcesId);
	...
	public ExpedientDocumentDto findOneAmbInstanciaProces(
		...
		String processInstanceId,
		Long documentStoreId) {
		log.debug("Consulta un document de la instància de procés (" +
			"expedientId=" + expedientId + ", " +
			"processInstanceId=" + processInstanceId + ", " +
			"documentStoreId=" + documentStoreId + ")");
		...
		throw new RuntimeException("Method findOneAmbInstanciaProces not implemented");
//		documentHelper.findDocument(
//			expedientId,
//			processInstanceId,
//			documentStoreId,
...
//		return null;
	...
	public Long guardarDocumentProces(
		...
		log.debug("Guardar document procés (" +
			"processInstanceId=" + processInstanceId + ", " +
			"documentCodi=" + documentCodi + ", " +
			"data=" + data + ", " +
			"titol=" + titol + ", " +
...
//			expedient.isArxiuActiu());
	...
	public void update(
		...
		String ntiIdOrigen) {
		log.debug("Modificar document de l'expedient (" +
			"expedientId=" + expedientId + ", " +
			"processInstanceId=" + processInstanceId + ", " +
			"documentStoreId=" + documentStoreId + ", " +
			"data=" + data + ", " +
	...
	public Long create(
		...
		String ntiIdOrigen,
		List<ExpedientDocumentDto> annexosPerNotificar) {
		log.debug("Crear document a dins l'expedient (" +
			"expedientId=" + expedientId + ", " +
			"processInstanceId=" + processInstanceId + ", " +
			"documentCodi=" + documentCodi + ", " +
			"data=" + data + ", " +
		...
		expedientLoggerHelper.afegirLogExpedientPerProces(
			...
			isAdjunt ?
				...
				: ExpedientLog.ExpedientLogAccioTipus.PROCES_DOCUMENT_AFEGIR,
			documentCodi);
		Long documentStoreId = documentHelper.setDocument(
			null,
			processInstanceId,
			null,
			documentCodi,
	...
	public ArxiuDto arxiuFindAmbDocument(
		...
		String processInstanceId,
		Long documentStoreId) {
		log.debug("Consulta de l'arxiu del document de la instància de procés (" +
			"expedientId=" + expedientId + ", " +
			"processInstanceId=" + processInstanceId + ", " +
			"documentStoreId=" + documentStoreId + ")");
		Expedient expedient = expedientHelper.getExpedientComprovantPermisos(
	...
	public ArxiuDto getArxiuVersioOriginal(Long expedientId, Long documentStoreId) {
		log.debug("Consulta de l'arxiu del document original (" +
			"expedientId=" + expedientId + ", " +
			"documentStoreId=" + documentStoreId + ")");
		...
		if (documentStore.getArxiuContingut() == null && documentStore.getArxiuUuid() != null) {
				...
				if(!nom.contains(".")) {
					...
					if (documentArxiu.getMetadades().getExtensio() != null) {
						...
						try {
							...
							log.warn("Error obtenint l'extensió pel mime type " + documentArxiu.getContingut().getTipusMime() + " pel documentStore " + documentStore.getId(), e);
						}
					}
					nom += extensio;
				}
			...
			arxiu.setTipusMime(documentHelper.getContentType(documentStore.getArxiuNom()));
		}
	...
	public void refreshComandaTasca(String taskId, TascaEstat estat) {
		try {
			...
			log.error("Error inesperat refrescant dades de comanda per la tasca amb ID: " + taskId, e);
		}
	}
}
