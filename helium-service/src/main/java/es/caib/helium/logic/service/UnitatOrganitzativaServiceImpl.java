...
public class UnitatOrganitzativaServiceImpl implements UnitatOrganitzativaService {
	...
	public UnitatOrganitzativaDto update(
		...
		UnitatOrganitzativa unitatOrganitzativaEntity = unitatOrganitzativaRepository.findById(unitatDto.getId()).orElse(null);
	...
	public UnitatOrganitzativaDto delete(
		...
		UnitatOrganitzativa unitatOrganitzativaEntity = unitatOrganitzativaRepository.findById(id).orElse(null);
	...
	public void synchronize(Long entitatId) {
		UnitatOrganitzativa unitatOrganitzativa = unitatOrganitzativaRepository.findById(entitatId).orElse(null);
...
//		cacheHelper.evictUnitatsOrganitzativesFindArbreByPare(unitatOrganitzativa.getCodiDir3Entitat());
	...
	public ArbreDto<UnitatOrganitzativaDto> findTree(Long id) {
		UnitatOrganitzativa entitat = unitatOrganitzativaRepository.findById(id).orElse(null);
