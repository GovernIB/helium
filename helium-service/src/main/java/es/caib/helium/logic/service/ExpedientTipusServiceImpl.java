...
import es.caib.helium.logic.intf.exportacio.ConsultaCampExportacio;
import es.caib.helium.logic.intf.exportacio.ConsultaExportacio;
...
import es.caib.helium.logic.intf.exportacio.DominiExportacio;
import es.caib.helium.logic.intf.exportacio.EnumeracioExportacio;
import es.caib.helium.logic.intf.exportacio.EnumeracioValorExportacio;
import es.caib.helium.logic.intf.exportacio.EstatExportacio;
...
import es.caib.helium.logic.intf.exportacio.MapeigSistraExportacio;
...
//	private FirmaTascaRepository firmaTascaRepository;
	...
	public ExpedientTipusDto importar(
		...
		for (DominiDto d : dominiMs.llistaDominiByEntorn(entorn.getId()))
