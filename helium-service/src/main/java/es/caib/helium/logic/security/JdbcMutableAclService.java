...
public class JdbcMutableAclService extends JdbcAclService implements MutableAclService {
    ...
    public JdbcMutableAclService(DataSource dataSource, LookupStrategy lookupStrategy, AclCache aclCache) {
        ...
        try {
	        String dialecteBBDD = GlobalProperties.getInstance().getProperty(PropertyConfig.PROP_HIBERNATE_DIALECT);
	...
	protected Long retrieveObjectIdentityPrimaryKey(ObjectIdentity oid) {
        try {
            return jdbcTemplate.queryForObject(selectObjectIdentityPrimaryKey, new Object[] {oid.getType(), oid.getIdentifier()} , Long.class);
