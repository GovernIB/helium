	...
	public ConversioTipusHelper() {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<Document, DocumentDto>() {
					@Override
					public DocumentDto convert(Document source, Type<? extends DocumentDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<Camp, CampDto>() {
					@Override
					public CampDto convert(Camp source, Type<? extends CampDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<CampTasca, CampTascaDto>() {
					public CampTascaDto convert(CampTasca source, Type<? extends CampTascaDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<DocumentTasca, DocumentTascaDto>() {
					public DocumentTascaDto convert(DocumentTasca source, Type<? extends DocumentTascaDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<FirmaTasca, FirmaTascaDto>() {
					public FirmaTascaDto convert(FirmaTasca source, Type<? extends FirmaTascaDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<Consulta, ConsultaDto>() {
					@Override
					public ConsultaDto convert(Consulta source, Type<? extends ConsultaDto> destinationType, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<ExpedientTipus, ExpedientTipusDto>() {
					@Override
					public ExpedientTipusDto convert(ExpedientTipus source, Type<? extends ExpedientTipusDto> destinationType, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<ExpedientTipusDto, ExpedientTipus>() {
					@Override
					public ExpedientTipus convert(ExpedientTipusDto source, Type<? extends ExpedientTipus> destinationType, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<Enumeracio, EnumeracioDto>() {
					@Override
					public EnumeracioDto convert(Enumeracio source, Type<? extends EnumeracioDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<CampRegistre, CampRegistreDto>() {
					@Override
					public CampRegistreDto convert(CampRegistre source, Type<? extends CampRegistreDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<ConsultaCamp, ConsultaCampDto>() {
					@Override
					public ConsultaCampDto convert(ConsultaCamp source, Type<? extends ConsultaCampDto> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<PersonaDto, Persona>() {
					@Override
					public Persona convert(PersonaDto source, Type<? extends Persona> destinationClass, MappingContext mappingContext) {
		...
		mapperFactory.getConverterFactory().registerConverter(
				new CustomConverter<Portasignatures, PortasignaturesDto>() {
					...
					public PortasignaturesDto convert(
							...
							Type<? extends PortasignaturesDto> destinationType, MappingContext mappingContext) {
