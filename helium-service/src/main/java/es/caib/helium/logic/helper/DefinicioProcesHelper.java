...
public class DefinicioProcesHelper {
	...
	public DefinicioProces importar(
		...
		ExpedientTipus expedientTipus = expedientTipusId != null ? 
						expedientTipusRepository.findById(expedientTipusId).get() : null;
	...
	public void copiarDefinicioProces(
			Long origenId, 
			Long destiId) {
		DefinicioProces origen = definicioProcesRepository.findById(origenId).get();
		DefinicioProces desti =  definicioProcesRepository.findById(destiId).get();
