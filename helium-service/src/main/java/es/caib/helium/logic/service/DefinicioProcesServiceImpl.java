...
public class DefinicioProcesServiceImpl implements DefinicioProcesService {
	...
	public void delete(
		...
		if (definicioProces.getExpedientTipus() != null) {
			ExpedientTipus expedientTipus = expedientTipusRepository.findById(definicioProces.getExpedientTipus().getId()).orElse(null);
	...
	public DefinicioProcesDto tascaFindDefinicioProcesDeTasca(Long tascaId) {
		...
		return conversioTipusHelper.convertir(
				tascaRepository.findById(tascaId).orElse(null).getDefinicioProces(),
				DefinicioProcesDto.class);
	}
	...
	public TascaDto tascaUpdate(TascaDto tasca)
		...
		logger.debug(
				...
				"tasca =" + tasca + ")");
		Tasca entity = tascaRepository.findById(tasca.getId()).orElse(null);
	...
	public CampTascaDto tascaCampCreate(
		...
		entity.setCamp(campRepository.findById(tascaCamp.getCamp().getId()).orElse(null));
		if (tascaCamp.getExpedientTipusId() != null) {
			ExpedientTipus expedientTipus = expedientTipusRepository.findById(tascaCamp.getExpedientTipusId()).orElse(null);
	...
	public void tascaCampDelete(Long tascaCampId) throws NoTrobatException, PermisDenegatException {
		...
		CampTasca tascaCamp = campTascaRepository.findById(tascaCampId).orElse(null);
	...
	public boolean tascaCampMourePosicio(
		...
		boolean ret = false;
		CampTasca tascaCamp = campTascaRepository.findById(campTascaId).orElse(null);
		if (tascaCamp != null) {
	...
	public CampTascaDto tascaCampUpdate(CampTascaDto tascaCamp)
		...
		CampTasca entity = campTascaRepository.findById(tascaCamp.getId()).orElse(null);
	...
	public CampTascaDto tascaCampFindById(
		...
		CampTasca campTasca = campTascaRepository.findById(campTascaId).orElse(null);
		if (campTasca == null) {
	...
	public DocumentTascaDto tascaDocumentCreate(
		...
		Tasca tasca = tascaRepository.findById(tascaId).orElse(null);
		entity.setTasca(tasca);
		entity.setDocument(documentRepository.findById(tascaDocument.getDocument().getId()).orElse(null));
		if (tascaDocument.getExpedientTipusId() != null) {
			ExpedientTipus expedientTipus = expedientTipusRepository.findById(tascaDocument.getExpedientTipusId()).orElse(null);
			// Només relaciona el camp tasca amb el tipus d'expedient si la tasca està heretada
			if (definicioProcesHelper.isTascaHeretada(tasca, expedientTipus))
				entity.setExpedientTipus(expedientTipus);
		}
	...
	public void tascaDocumentDelete(Long tascaDocumentId) throws NoTrobatException, PermisDenegatException {
		...
		DocumentTasca tascaDocument = documentTascaRepository.findById(tascaDocumentId).orElse(null);
	...
	public boolean tascaDocumentMourePosicio(
		...
		boolean ret = false;
		DocumentTasca tascaDocument = documentTascaRepository.findById(id).orElse(null);
		if (tascaDocument != null) {
			if (expedientTipusId == null) {
				Tasca tasca = tascaRepository.findById(tascaDocument.getTasca().getId()).orElse(null);
	...
	public DocumentTascaDto tascaDocumentUpdate(DocumentTascaDto tascaDocument)
		...
		DocumentTasca entity = documentTascaRepository.findById(tascaDocument.getId()).orElse(null);
	...
	public DocumentTascaDto tascaDocumentFindById(
		...
		DocumentTasca documentTasca = documentTascaRepository.findById(documentTascaId).orElse(null);
	...
	public FirmaTascaDto tascaFirmaCreate(
		...
		Tasca tasca = tascaRepository.findById(tascaId).orElse(null);
		entity.setTasca(tasca);
		entity.setDocument(documentRepository.findById(tascaFirma.getDocument().getId()).orElse(null));
		if (tascaFirma.getExpedientTipusId() != null) {
			ExpedientTipus expedientTipus = expedientTipusRepository.findById(tascaFirma.getExpedientTipusId()).orElse(null);
			// Només relaciona el camp tasca amb el tipus d'expedient si la tasca està heretada
			if (definicioProcesHelper.isTascaHeretada(tasca, expedientTipus))
				entity.setExpedientTipus(expedientTipus);
		}
	...
	public void tascaFirmaDelete(Long tascaFirmaId) throws NoTrobatException, PermisDenegatException {
		...
		FirmaTasca tascaFirma = firmaTascaRepository.findById(tascaFirmaId).orElse(null);
	...
	public boolean tascaFirmaMourePosicio(
		...
		boolean ret = false;
		FirmaTasca tascaFirma = firmaTascaRepository.findById(id).orElse(null);
		if (tascaFirma != null) {
			if (expedientTipusId == null) {
				Tasca tasca = tascaRepository.findById(tascaFirma.getTasca().getId()).orElse(null);
				if (tasca.getDefinicioProces().getExpedientTipus() != null)
					expedientTipusId = tasca.getDefinicioProces().getExpedientTipus().getId();
			}
	...
	public FirmaTascaDto tascaFirmaUpdate(FirmaTascaDto tascaFirma)
		...
		FirmaTasca entity = firmaTascaRepository.findById(tascaFirma.getId()).orElse(null);
	...
	public FirmaTascaDto tascaFirmaFindById(
		...
		FirmaTasca firmaTasca = firmaTascaRepository.findById(firmaTascaId).orElse(null);
		if (firmaTasca == null) {
