 ...
 * 
 */
package es.caib.helium.service.helpers;
...
//		return errors.isEmpty();
	...
	private Object updateDocumentFromExpedient(
			Object docLucene, 
			final Expedient expedient, 
			Map<String, DefinicioProces> definicionsProces, 
			Map<String, Set<Camp>> camps, 
...
//		return document;
	...
	private void createOrUpdateDocumentField(Object document, Object field, boolean isUpdate) {
//		if (isUpdate)
//			document.removeFields(field.name());
//		document.add(field);
	}

	private void removeDocumentField(Object document, String field) {
//		document.removeFields(field);
	}

	protected Object getLuceneQuery(
			Entorn entorn,
			ExpedientTipus expedientTipus,
			List<Camp> filtreCamps,
			Map<String, Object> filtreValors) {
...
//		return (bquery.getClauses().length > 0) ? bquery : new MatchAllDocsQuery();
	...
	protected Object getLuceneSort(
			PaginacioParamsDto paginacioParams,
			List<Camp> informeCamps) {
...
//				} else {
//					sort[paginacioParams.getOrdres().indexOf(ordre)] = clau.replace(".", ExpedientCamps.EXPEDIENT_PREFIX_SEPARADOR);
//				}
//				
//			}
//			if(sort.length == 0)
...
//		return luceneSort;
	...
	protected Object queryFromCampFiltre(
			String codiCamp,
			Object valorFiltre,
			List<Camp> camps) {
//		try {
...
//		}
	...
	private Object queryPerStringAmbWildcards(String codi, String termes) {		
...
//		return booleanQuery;
	...
	private Object termIdFromExpedient(Expedient expedient) {
...
//		return resposta;
	...
	private void updateDocumentCamp(Object document, DefinicioProces definicioProces, Camp camp, Object valor, Map<String, String> textDominis, boolean checkMultiple, boolean isUpdate, Set<String> campsActualitzats) {
//		String clauIndex;
