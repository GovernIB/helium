...
public class TerminiServiceImpl implements TerminiService {
	...
	public TerminiDto findAmbId(
		...
		logger.debug(
				...
				"terminiId=" + terminiId +  ")");
		Termini termini = terminiRepository.findById(terminiId).orElse(null);
		if (termini == null) {
	...
	public TerminiDto create(
		...
		if (definicioProcesId != null)
			termini.setDefinicioProces(definicioProcesRepository.findById(definicioProcesId).orElse(null));
	...
	public TerminiDto update(TerminiDto dto) {
		Termini termini = terminiRepository.findById(dto.getId()).orElse(null);
		if (termini == null) {
