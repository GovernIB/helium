	...
	public List<String> findRolsAmbCodi(String codi) throws PersonesPluginException {
		...
		try {
			...
			if (query != null && !query.isEmpty()) {
				...
				String driver = GlobalProperties.getInstance().getProperty("app.persones.plugin.jdbc.driver");
				String url = GlobalProperties.getInstance().getProperty("app.persones.plugin.jdbc.url");
				String username = GlobalProperties.getInstance().getProperty("app.persones.plugin.jdbc.username");
				String password = GlobalProperties.getInstance().getProperty("app.persones.plugin.jdbc.password");
