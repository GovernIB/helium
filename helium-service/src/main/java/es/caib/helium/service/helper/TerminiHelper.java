...
import es.caib.helium.persistence.entity.Festiu;
...
public class TerminiHelper {
	...
	public TerminiIniciatDto iniciar(
		...
		Termini termini = terminiRepository.getReferenceById(terminiId);
		if (termini == null)
	...
	public void pausar(Long terminiIniciatId, Date data, boolean crearRegistre) {
		TerminiIniciat terminiIniciat = terminiIniciatRepository.getReferenceById(terminiIniciatId);
		if (terminiIniciat == null)
	...
	public Termini findTerminiById(Long terminiId) {
		return terminiRepository.getReferenceById(terminiId);
	}

	public TerminiIniciat findTerminiIniciatById(Long terminiIniciatId) {
		return terminiIniciatRepository.getReferenceById(terminiIniciatId);
	}
	...
	public void deleteTermini(Long id) {
		Termini vell = terminiRepository.getReferenceById(id);
		if (vell != null) {
