...
import es.caib.helium.commons.dto.ArbreNodeDto;
...
import es.caib.helium.commons.dto.TipusTransicioEnumDto;
...
public class UnitatOrganitzativaHelper {
	...
	public UnitatOrganitzativa findById(Long unitatOrganitzativaId) {
		return unitatOrganitzativaRepository.getReferenceById(unitatOrganitzativaId);	
	}
...
//					unitat.setCodiDir3Entitat(codiEntitat);
		...
		public List<UnitatOrganitzativaDto> getNewFromWS(Long entidadId){
			UnitatOrganitzativa entitat = unitatOrganitzativaRepository.findById(entidadId).orElse(null);
