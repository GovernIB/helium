...
import es.caib.helium.persistence.entity.Tasca.TipusTasca;
...
//				contingutDeploy);
	...
	public void copiarDefinicioProces(
			Long origenId, 
			Long destiId) {
		DefinicioProces origen = definicioProcesRepository.findById(origenId).orElse(null);
		DefinicioProces desti =  definicioProcesRepository.findById(destiId).orElse(null);
