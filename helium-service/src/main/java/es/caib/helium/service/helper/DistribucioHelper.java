...
import es.caib.helium.commons.dto.AnotacioInteressatDto;
...
import es.caib.helium.persistence.entity.MapeigSistra.TipusMapeig;
...
import es.caib.helium.persistence.repository.AnotacioInteressatRepository;
...
public class DistribucioHelper {
	...
	public Anotacio resetConsulta(long anotacioId, String errorProcessament) 
	{
		...
		anotacioAnnexRepository.deleteAll(anotacio.getAnnexos());
		anotacioInteressatRepository.deleteAll(anotacio.getInteressats());
	...
	public AnotacioAnnex updateErrorAnnex(long annexId, String error) {
		...
		AnotacioAnnex anotacioAnnex = anotacioAnnexRepository.findById(annexId).orElse(null);
