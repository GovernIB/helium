...
public class ReproServiceImpl implements ReproService {
	...
	public ReproDto findById(Long id) {
		Repro repro = reproRepository.findById(id).orElse(null);
		if (repro == null)
