...
//		crearEnumeracio(true);  // crear enumeraci� que ja existeix
//		
//		seleccionarDefProc();   // seleccionar def. de proc�s
//		
//		crearVariables();
//		modificarVariable();
//		validacioVar();
...
//	// --------------------------------------------------------------------------------------------------------------
//
//	public static void importPar(boolean tipExp) throws InterruptedException {
//		
...
//		}*/
//		
//		// assertEquals("La versi� resultant no �s correcta", versio + 1, novaVersio);
//	}
//
//	public static void seleccionarDefProc() throws InterruptedException {
//		// Seleccionar una definici� de proc�s que s'utilitzar� per fer les proves
//		
//		// Acc�s a l'opci� de men�
//		WebElement menuDisseny = driver.findElement(By.id("menuDisseny"));
...
//		
//		// Obtenir nom de la defici� de proc�s i cercar-lo
...
//
//		if (!isPresent) {
//			assertFalse("No s'ha trobat la defici� de proc�s", isPresent);
//		}
//		else
//		{
//			driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + nomDefProc + "')]/td[1]/a")).click();
//			screenshotHelper.saveScreenshot("defproces/selecDefProc2.png");
//		}
//	}
//
//	public static void crearEnumeracio(boolean existeix) throws InterruptedException {
//		// Crear una enumeraci� per poder definir una variable de tipus selecci�			
//		
//		WebElement menuDisseny = driver.findElement(By.id("menuDisseny"));
...
//			driver.findElement(By.id("nom0")).sendKeys("S�");
...
//				
//			// Comprovar que s'han creat els elements de l'enumeraci�
//			driver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
...
//				assertFalse("No s'ha pogut crear els elements de l'enumeraci�", isPresent);
//			}		
//
//			boto = driver.findElement(By.xpath("//button[@value='cancel']"));
//			boto.click();
...
//		// Crear variables en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
...
//		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//		if (!isPresent) {
//			assertFalse("No s'ha pogut crear la variable m�ltiple", isPresent);
//		}		
//		
//		// variable oculta
//		driver.findElement(By.xpath("//div[@id='content']/form/button[@class='submitButton']")).click();
...
//		// Afegeix una validaci� a una variable			
//		
//		// Accedir a la fitxa de les variables
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/campLlistat.html')]")).click();			
//			
...
//			driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//			if (!isPresent) {
//				assertFalse("No s'ha pogut crear la validaci� de la variable string", isPresent);
//			}*/		
// 	    } else {
//			fail("La variable no existeix");
//		}
...
//		// Esborra una variable en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa de les variables
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/campLlistat.html')]")).click();			
//			
...
//		// Crear una agrupaci� de variables en una definici� de proc�s seleccionada amb seleccionarDefProc
...
//		driver.findElement(By.id("nom0")).sendKeys("Nom agrupaci� variables 01");
//
...
//		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//		if (!isPresent) {
//			assertFalse("No s'ha pogut crear l'agrupaci�", isPresent);
//		}		
//	}
//
//	public void crearVarAgrupacio() throws InterruptedException {
//		// Afegeix una variable una agrupaci� de variables 
//		
//		// Accedir a la fitxa de les agrupacions
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/campAgrupacioLlistat.html')]")).click();			
//			
...
//		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//		if (!isPresent) {
//			assertFalse("L'agrupaci� no existeix", isPresent);
//		}		
//		else {
//			// Bot� Assignar variable
...
//			driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//			if (!isPresent) {
//				assertFalse("No s'ha pogut crear la variable de l'agrupaci�", isPresent);
//			}
//		}
//	}	
//	
//	private void esborrarAgrupacio() {
//		// Esborra una agrupaci� de variables en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa de les agrupacions
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/campAgrupacioLlistat.html')]")).click();			
//			
...
//			driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//			
//			assertFalse("No s'ha pogut eliminar l'agrupaci�", isPresent);
//		} else {
//			fail("L'agrupaci� no existeix");
//		}
//	}	
//	
//	private void esborrarVarAgrupacio() {
//		// Esborra una variable d'una agrupaci� de variables, en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa de les agrupacions
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/campAgrupacioLlistat.html')]")).click();			
//			
...
//			driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//			
//			assertFalse("No s'ha pogut eliminar la variable de l'agrupaci�", isPresent);
//		} else {
//			fail("La variable no existeix en l'agrupaci�");
//		}
//	}	
//	
//	public static void adjuntarDoc() throws InterruptedException {
//		// Adjunta un document a una defici� de proc�s seleccionada amb seleccionarDefProc			
//		
...
//		// Adjunta un document tipus plantilla a una defici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa dels documents
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/documentLlistat.html')]")).click();			
//			
...
//		// Esborra un document d'una definici� de proc�s seleccionada amb seleccionarDefProc			
//	
//		// Accedir a la fitxa dels documents
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/documentLlistat.html')]")).click();			
//		
...
//		// Crear un termini en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
...
//		// Esborra un termini d'una definici� de proc�s seleccionada amb seleccionarDefProc			
//	
//		// Accedir a la fitxa dels terminis
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/terminiLlistat.html')]")).click();			
//		
...
//		// Afegeix una variable a una tasca en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
...
//		// Modifica una variable a obligat�ria d'una tasca en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa de les tasques
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/tascaLlistat.html')]")).click();			
//			
//  	    screenshotHelper.saveScreenshot("defproces/tasca/modif_var1.png");
//
//  	    String codTasca = getProperty("defproc.tasca.codi1");
//  	    String codVar = getProperty("defproc.variable.codi1")+"/"+getProperty("defproc.variable.nom1");
//  	    // Bot� variables
...
//		if (isPresent) {
//	  	    // guardar valor inicial
//	  	    boolean valIni = driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + codVar + "')]/td[4]/input")).isSelected(); 
//	  	    screenshotHelper.saveScreenshot("defproces/tasca/modif_var2.png");
//	  	    
//	  	    // Modificar variable
//	  	    driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + codVar + "')]/td[4]/input")).click();  	    
//	  	    screenshotHelper.saveScreenshot("defproces/tasca/modif_var3.png");
//	  	    driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + codVar + "')]/td[7]/div/input")).click();
//	  	    screenshotHelper.saveScreenshot("defproces/tasca/modif_var4.png");
//	  	    
//	  	    // comprovar si s'ha modificat la variable
//	  	    boolean valFin = driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + codVar + "')]/td[4]/input")).isSelected();
//			assertNotEquals("No s'ha pogut modificar la variable de la tasca", valIni, valFin);
// 	    } else {
//			fail("La variable no existeix");
//		}
//	}	
...
//		// Esborra una variable d'una tasca en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa de les tasques
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/tascaLlistat.html')]")).click();			
//			
...
//		// Afegeix un document a una tasca en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
...
//		// Modifica un document d'una tasca com obligatoris, en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa de tasques
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/tascaLlistat.html')]")).click();			
//			
...
//		if (isPresent) {
//	  	    // guardar valor inicial
//			String valIni = driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + nomDoc + "')]/td[2]")).getText().trim();
//	  	    screenshotHelper.saveScreenshot("defproces/tasca/modif_doc3.png");
//	  	    
//			// Seleccionar document 
//			WebElement selectVar = driver.findElement(By.id("documentId0"));
//			List<WebElement> allOptions = selectVar.findElements(By.tagName("option"));
//			for (WebElement option : allOptions) {
//			    if (option.getText().equals(nomDoc)) {
//			    	option.click();
//			    	break;
//			    }
//			}
...
//
//			// comprovar si s'ha modificat el document
//	  	    String valFin = driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + nomDoc + "')]/td[2]")).getText().trim();
//			assertNotEquals("No s'ha pogut modificar el document de la tasca", valIni, valFin);
// 	    } else {
//			fail("El document no existeix");
//		}
//		
...
//		// Esborra un document d'una tasca en una definici� de proc�s seleccionada amb seleccionarDefProc			
//		
//		// Accedir a la fitxa de les tasques
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/tascaLlistat.html')]")).click();			
//			
...
//		// Eliminar una definici� de proc�s 
//		
//		// Acc�s a l'opci� de men�
//		WebElement menuDisseny = driver.findElement(By.id("menuDisseny"));
//		WebElement menuDefProc = driver.findElement(By.xpath("//a[contains(@href, '/helium/definicioProces/llistat.html')]"));
...
//		driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//
//		if (isPresent) {  // si existeix esborrar-lo
//			driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + nomDefProc + "')]/td[4]/a")).click();
//			driver.switchTo().alert().accept();
//			screenshotHelper.saveScreenshot("defproces/elimDefProc2.png");
//		}
//		else
//		{
//			fail("La definici� de proc�s no existeix");
//		}
//	}
