...
//		// Seleccionar un tipus d'expedient que s'utilitzar� per fer les proves
//		
...
//		// Modifica el camp Expressi� per calcular el n�mero d'un tipus d'expedient
//		seleccionarTipExp();
//		
...
//		// Marcar com proc�s principal d'un tipus d'expedient una determinada definici� de proc�s 
//		WebElement menuDisseny = driver.findElement(By.id("menuDisseny"));
//		WebElement menuTipExpedient = driver.findElement(By.xpath("//a[contains(@href, '/helium/expedientTipus/llistat.html')]"));
//
//		// Accedir a l'opci� de men� Tipus d'expedient
//		Actions actions = new Actions(driver);
//		actions.moveToElement(menuDisseny);
//		actions.build().perform();
//
...
//            
//			// Accedir al tipus d'expedient i a la Definici� de proc�s			
//			driver.findElement(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'" + codTipExp + "')]/td[1]/a")).click();
...
//			
//			// Obtenir nom de la definici� de proc�s i cercar-lo
...
//
//			if (!isPresent1) {
//				assertFalse("No s'ha trobat la definici� de proc�s", isPresent1);
//			}
//			else
//			{
...
//			driver.findElement(By.id("nom0")).sendKeys("Revisi� documentaci� sol�licitud");
//
...
//		// Crea una enumeraci� d'un tipus d'expedient
//		seleccionarTipExp();	
...
//			driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//			if (!isPresent) {
//				assertFalse("No s'ha pogut crear l'enumeraci� del tipus d'expedient", isPresent);
//			}					
//		}
//	}
//	
//	public void modificarEnumTipExp() throws InterruptedException {
//		// Modifica el nom una enumeraci� d'un tipus d'expedient
//		seleccionarTipExp();	
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/expedientTipus/enumeracioLlistat.html')]")).click();
...
//			assertNotEquals("No s'ha pogut modificar l'enumeraci� del tipus d'expedient", valIni, valFin);	
//		}
//		else {
//			fail("L'enumeraci� del tipus d'expedient no existeix");
//		}
//	}
//	
//	public void crearValEnumTipExp() throws InterruptedException {
//		// Assigna valors a una enumeraci� d'un tipus d'expedient
//		seleccionarTipExp();	
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/expedientTipus/enumeracioLlistat.html')]")).click();
...
//				assertFalse("No s'han pogut crear els elements de l'enumeraci� del tipus d'expedient", isPresent);
//			}		
//
...
//		// Modifica valors d'una enumeraci� d'un tipus d'expedient
//		seleccionarTipExp();	
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/expedientTipus/enumeracioLlistat.html')]")).click();
...
//				assertNotEquals("No s'ha pogut modificar el valor de l'enumeraci� del tipus d'expedient", valIni, valFin);	}
//			else {
//				fail("El valor de l'enumeraci� del tipus d'expedient no existeix");
//			}
//		}
//		else {
//			fail("L'enumeraci� del tipus d'expedient no existeix");
...
//		// Ordena valors d'una enumeraci� d'un tipus d'expedient
//		seleccionarTipExp();	
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/expedientTipus/enumeracioLlistat.html')]")).click();
...
//				assertNotEquals("No s'ha pogut ordenar el valor de l'enumeraci� del tipus d'expedient", valIni, valFin);	}
//			else {
//				fail("El valor de l'enumeraci� del tipus d'expedient no existeix");
//			}
//		}
...
//		// Esborra valors a una enumeraci� d'un tipus d'expedient
//		seleccionarTipExp();	
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/expedientTipus/enumeracioLlistat.html')]")).click();
...
//				isPresent = driver.findElements(By.xpath("//*[@id='registre']/tbody/tr[contains(td[1],'A')]")).size() > 0;
//				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
//				assertFalse("No s'ha pogut esborrar el valor de l'enumeraci� del tipus d'expedient", isPresent);
//			}
//			else {
//				fail("El valor de l'enumeraci� del tipus d'expedient no existeix");
//			}
...
//		// Esborra una enumeraci� d'un tipus d'expedient
//		seleccionarTipExp();	
//		driver.findElement(By.xpath("//a[contains(@href, '/helium/expedientTipus/enumeracioLlistat.html')]")).click();
//	
//		String codEnum = getProperty("tipexp.enum.codi1");
...
//
//			assertFalse("No s'ha pogut esborrar l'enumeraci� del tipus d'expedient", isPresent);
//		}
//		else {
//			fail("L'enumeraci� del tipus d'expedient no existeix");
//		}
