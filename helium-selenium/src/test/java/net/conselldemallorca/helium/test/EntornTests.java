...
//		testEntornSeleccionar(true); // des de la llista d'entorns del men� Seleccionar entorn
...
//			assertNotEquals("No s'ha pogut canviar el t�tol de l'entorn de test", titol, nouTitol);
//		}
//	}
//	
//	
...
//				assertFalse("No s'han pogut eliminar els permisos", isPresent);
//			} else {
//				fail(userol + " no té permisos per aquuest entorn.");
//			}
//		} else {
//			fail("Entorn no existeix");
//		}
